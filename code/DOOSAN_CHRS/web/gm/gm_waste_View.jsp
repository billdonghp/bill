...
function search(){
	...
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=wasteView&menu_code=${param.menu_code}&flag=1";
	document.ApplyForm.submit();
}

function Add() {
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=addWasteView&menu_code=${param.menu_code}";
	document.ApplyForm.submit();
}
function Update() {
	...
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=updateWasteView&menu_code=${param.menu_code}&wasteId="+document.ApplyForm.temp.value;
	document.ApplyForm.submit();
}
function Delete() {
	if(document.ApplyForm.temp.value==0) {
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
	 ...
	 <!-- Page Navigation Start-->
					<ait:page       
		               ...
		               parameters="&operation=waste&content=wasteView&menu_code=${param.menu_code}&wasteType=${wasteType}&StartTime=${StartTime}&EndTime=${EndTime}&NO=${NO}&Company_Customers=${Company_Customers}"
		               total="${recordCount}"
