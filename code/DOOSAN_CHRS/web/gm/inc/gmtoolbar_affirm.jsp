	  ...
	  <table width="99%" border="0" cellpadding="0" cellspacing="0">
        <tr>
         <td align="left" valign="middle" style="padding:3 0 3 0 ">
		  ...
		  <ait:image src="/images/btn/Bulk_Over.gif" align="absmiddle"
          	onclick="javascript:doOK();" style="cursor:hand" />
          	 <ait:image src="/images/btn/Excel_Exp.gif" style="cursor: pointer;" onclick="ImportExcel();"/>
