	...
	<tr>
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		    ...
		    <tr align="center">
		      ...
		      int isdelete=ga.getDeleteWasteOperationInfo(admin.getAdminID(),wasteBean.getWASTEUNITPRICE_ID(),"ga_waste_apply_affirm affirm");%>
		      <!-- 下面代表决裁者 -->
		      <%if(!list.isEmpty()){%>
		      <table>
		      ...
		      <td width="6%" align="center" class="info_content_00"><%if(isdelete==0){%><a href="/gaControlServlet?menu_code=ga0507&operation=gaAffirm&content=deleteWasteApply&affirmno=<%=wasteBean.getWASTEUNITPRICE_ID() %>" onclick="return(confirm('确认删除吗？这将清空所有的相关信息！'))"><font color="red">删除</font></a><%}else{%>&nbsp;<%} %></td>
		    </tr>
		    <% }%>		  
		    <tr align="center"> 
			 </tr>
...
<table>
 ...
 <%for(int pagesize=1;pagesize<=(listsize!=10?(listsize/10)+1:1);pagesize++){%>
	<a href="/gaControlServlet?menu_code=ga0507&operation=gaAffirm&content=wasteAffirmInfo&page=<%=pagesize%>">
