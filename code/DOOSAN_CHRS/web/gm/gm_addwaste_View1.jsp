...
function Save()
{
	...
	document.form1.action="/gmControlServlet?operation=waste&content=addWaste1&menu_code=${param.menu_code}";
...
function Calculation(){
	...
	document.form1.total.value = (parseFloat(document.form1.wasteUnitPrice.value) * parseFloat(document.form1.wasteNumber.value)).toFixed(2);
}
...
function changeWasteaTypeShowUnitPrice(TypeId){
		...
		new Ajax.Request(
            ...
            onSuccess : function(transport) {
			   ...
			   document.form1.wasteUnitPrice.value= param.unitPrice; 
			   document.form1.Units.value = param.units; 
			   document.getElementById("UnitsName").innerHTML = param.unitsName;
			} 
		});
}	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td align="left" class="title1" colspan="10">废品添加</td>
			</tr>
		</table>
		<table width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td align="left" class="info_content_00" ><span id="UnitsName"></span>
					<input type="hidden" name="Units" readonly="readonly" value="" size="10"/>
				</td>
			</tr>
			<tr>
 				<td width="10%" class="info_title_01">单价</td>
				<td align="left" class="info_content_00">
					<input type="text" name="wasteUnitPrice" readonly="readonly" value="" size="10"/>&nbsp;元
				</td>
			</tr>
			<tr>
				<td width="10%" class="info_title_01"> 数量 </td>
 				<td align="left" class="info_content_00">
					<input name="wasteNumber" type="text" size="10" onchange="Calculation();"/>
 				</td>
			</tr>
 			<tr>
			<td width="10%" class="info_title_01"> 金额 </td>
				<td align="left" class="info_content_00">
 					<input name="total" type="text" value="" size="10" readonly="readonly" money/>&nbsp;元
 				</td>
 			</tr>
 			<tr>
				<td width="10%" class="info_title_01"> 客户公司 </td>
				<td align="left" class="info_content_00">
					<select name="Company_Customers">
						<option value="">
								请选择
						</option> 
 			...
 			<tr>
				...
				<td align="left" class="info_content_00">
					<input name="Company_other" type="text" value="" size="10" style="width: 250px"/>
 				</td>
 			</tr>
 			<tr>
 			...
 			<tr>
				...
				<td align="left" class="info_content_00">
					<input type="text" name="OUT_STAFF" value=""/>
 				</td>
 			</tr>
 			<tr>
				<td width="10%" class="info_title_01"> 搬出理由 </td>
				<td align="left" class="info_content_00">
					<ait:codeClass codeClass="CiteReasons" name="citeReasons"/>
 				</td>
 			</tr>
 			<tr>
				<td width="10%" class="info_title_01"> 车辆号 </td>
				<td align="left" class="info_content_00">
					<input type="text" name="CAR_NO" value="" style="width: 250px"/>
 				</td>
 			</tr>
 			<tr>
			<td width="10%" class="info_title_01"> 备注 </td>
				<td align="left" class="info_content_00">
 					<textarea name="remarks" style="height: 80px;width: 300px;"></textarea>
 				</td>
 			</tr>
		</table>
		</form>
