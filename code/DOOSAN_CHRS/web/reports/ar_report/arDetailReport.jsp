...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="center" height="60">
    <td colspan="2">             
	    <table width="100%">
	    	<tr>
	    		<td align="center" colspan="12"><b><font size="+2"><!-- 考勤明细维护报表 -->
    ...
    <td><table width="100%" border="2"   
      ...
      for(int i=0;i<datalist.size();i++)
      {
    	 ...
    	 <tr>
    	  ...
    	  <td align="center"><%=detail.getIsLock().equals("Y") ? "<font color='red'>锁定</font>" : "开放"%></td>
    	
    	   <td align="center"><%=detail.getDate_type() %></td>
    	    <td align="center"><%=detail.getAr_month_str() %></td>
    	     
    	   <% if("78000000".equals(admin.getCpnyId())){%> 
		      
		       <td align="center">
				    	<%=StringUtil.checkNull(detail.getRemark())%>
				</td>
