...
reportname = "63000000_pa_detail_all_person_b.rpt"
%>
...
While (Len(distinction) <> 0 And InStr(distinction, "," ) > 0)
	...
	session("oRpt").ParameterFields.GetItemByName("distinction").AddCurrentValue(CStr(Left(distinction,charIndexVal - 1)))
