...
reportname = "63000000_pa_detail_all_person_f.rpt"
%>
...
patype = Request.QueryString("patype")

Session("oRpt").ParameterFields.GetItemByName("empid").AddCurrentValue(CStr(empid))

Session("oRpt").ParameterFields.GetItemByName("startmonth").AddCurrentValue(CStr(startmonth))

Session("oRpt").ParameterFields.GetItemByName("endmonth").AddCurrentValue(CStr(endmonth))

Session("oRpt").ParameterFields.GetItemByName("patype").AddCurrentValue(CStr(patype))
