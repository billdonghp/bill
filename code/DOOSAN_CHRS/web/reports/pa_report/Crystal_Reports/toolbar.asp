...
Response.Expires = 0
' Viewer Tab images
drilld = "<img border=0 src='images/toolbar/pdrilld.gif' alt = 'Parent Group'>"
drillu = "<img border=0 src='images/toolbar/cdrillu.gif' alt = 'Current Group'>"
previewu = "<img border=0 src='images/toolbar/pviewu.gif' alt = 'Preview'>"
previewd =  "<img border=0 src='images/toolbar/pviewd.gif' alt = 'Preview'>"
...
<body background="images/toolbar/toolbg.gif" topmargin=0 leftmargin=0 <% response.write messageText%>>
...
<td nowrap align=right width=10%><% response.write firstlink %><img border=0 src="images/toolbar/first.gif" alt="First page"><% response.write previouslink %><img border=0 src="images/toolbar/prev.gif" alt="Previous page"></td>
<td nowrap valign=center align=center width=10%> <b> <%response.write CurrentPageNumber %> </b> of <%response.write lastknownpage %></td>
<td nowrap align=left width=10%><%response.write nextlink %><img border=0 src="images/toolbar/next.gif" alt="Next page"></a><%response.write lastlink %><img border=0 src="images/toolbar/last.gif" alt="Last page"></a></td>
...
<td align=left width=5%> <input type=image   src="images/toolbar/gotopage.gif" alt="Goto Page"></td>
</form>
...
<td nowrap align=center width=15%><a href="javascript:parent.parent.location='rptserver.asp?cmd=rfsh&viewer=html%5Fframe&vfmt=html%5Fframe&page=<%response.write CurrentPageNumber %>'"><img border=0 src="images/toolbar/refresh.gif" alt="Refresh"></a></td>
<td align=right width=15%><input type=text size=10 maxlength=255 name=text></td>
<td align=left width=5%><input type=image src="images/toolbar/search.gif"></td>
