...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <td  align="center"><%=health.getChineseName()%>&nbsp;&nbsp;</td>
    <td  align="center"><%=health.getEmpID()%>&nbsp;&nbsp;</td>
    ...
    <td  height="30"  align="center"><a href="/ess/ess0505_t.jsp?healthNo=<%=health.getHealthNo()%>&flag=1&menu_code=<%=menu_code%>"><font color="#00CC00">通过</font></a><font color="#00CC00">&nbsp;/&nbsp;</font><a href="/ess/ess0505_t.jsp?healthNo=<%=health.getHealthNo()%>&flag=2&menu_code=<%=menu_code%>"><font color="#00CC00">不通过</font></a></td>
	        <%}else if(health.getActivity()==1){%>
    <td  height="30"  align="center"><font color="#990099"><%=health.getUpdatedBy()%>&nbsp;已通过</font></td>
