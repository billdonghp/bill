...
<body>
<div align="left">
<span class="title1">决裁信息查看>兵役信息决裁情况</span></div>
<!--form name="familyForm" action="/ess/ess0605.jsp">
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  <tr align="center">
    ...
    <td  height="30"  align="center" bgcolor="#F5F5F5">兵役种类</td>
  ...
  <tr align="center">
    ...
    <td  height="30"  align="center"><%=(String)record.get("MILITARY_TYPE")%>&nbsp;</td>
    <td  height="30"  align="center"><%=(String)record.get("MILITARY_LEVEL_CODE")%>&nbsp;</td>
    <td  height="30"  align="center"><%=(String)record.get("MILITARY_AREA")%>&nbsp;</td>
    <td  height="30"  align="center"><%=record.get("START_DATE").toString()%>&nbsp;</td>
    <td  height="30"  align="center"><%=record.get("END_DATE").toString()%>&nbsp;</td>
	        <%
	...
	<%if(act==0){%>
	<a href="javascript:deleteApply(<%=record.get("MILITARY_NO")%>,'<%=menu_code%>');">
	删除
	</a>
	<%}%>&nbsp;
	</td> -->
  ...
  <td width="11%">
  <a href="/EssContorlServlet?command=ArbitramentCircsCommandImp&content=ArbitramentCircsEscuageContentImp&menu_code=ess0605&pageno=<%=(p.getPagenum()/10)-10+1%>">
  ...
  <%for(int i=1;i<=p.getPagenum();i++){%>
	<td>
	<a href="/EssContorlServlet?command=ArbitramentCircsCommandImp&content=ArbitramentCircsEscuageContentImp&menu_code=ess0605&pageno=<%=i%>">
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="11%">
  <a href="/EssContorlServlet?command=ArbitramentCircsCommandImp&content=ArbitramentCircsEscuageContentImp&menu_code=ess0605&pageno=<%=(p.getPagenum()/10)*10-10+1%>"><img src="/images/btn/p_last101.gif" width="18" height="12" border="0" align="absmiddle"></a>
  </td>
  <%}%>
  <td>
 <%for(int i=(((p.getCurrent()-1)/10*10)+1);i<=(((p.getCurrent()-1)/10)+1)*10 && i<=p.getPagenum();i++){%>
	<a href="/EssContorlServlet?command=ArbitramentCircsCommandImp&content=ArbitramentCircsEscuageContentImp&menu_code=ess0605&pageno=<%=i%>"><font color="#666666" ><b><%=i%></b></font></a>&nbsp;
 <%}%>
 </td>
  <%if(p.getPagenum()/10!=0 && (((p.getCurrent()-1)/10*10)+1)+10<p.getPagenum()){%>
  <td width="11%">
  <a href="/EssContorlServlet?command=ArbitramentCircsCommandImp&content=ArbitramentCircsEscuageContentImp&menu_code=ess0605&pageno=<%=(p.getPagenum()/10)*10+1%>"><img src="/images/btn/p_next101.gif" width="18" height="12" border="0" align="absmiddle"></a>
  </td>
  <%}%>
  </tr>
</table>
