...
<script language="javascript">
 ...
 function clickaction (){
   	 var selectContent = document.matchForm.selectContent.value;
 	 var selectCondition = document.matchForm.selectCondition.value;
 	 var menu_code = document.matchForm.menu_code.value
 	 document.matchForm.action="/ess/ess0610.jsp?selectContent="+selectContent+"&selectCondition="+selectCondition;
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <a href="/ess/ess0600_t.jsp?menu_code=<%=menu_code%>&NO=<%=matchApply.getMatchApplyNo()%>&operate=matchApply&strPage=<%=x%>&selectContent=<%= selectContent%>&selectCondition=<%=selectCondition %>&selectContent=<%= selectContent%>&selectCondition=<%=selectCondition %>">删除</a>
    </td>
