...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<form name="ApplyForm" id="ApplyForm" action="/essControlServlet" method="POST">
			...
			<input type="hidden" name="content" value="evectionapply" />
			<input type="hidden" name="menu_code" value="<%=menu_code%>"/>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" >
			<tr>
				<td align="left" class="title1" colspan="10"><!-- 出差申请 -->
	<ait:message messageID="display.ess.attendance_request.biz_trip_request"  module="ess"></ait:message>				
				</td>
			</tr>
		</table>
		<%if (!errorMsg.equals("")) {%>
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		  <tr align="center">
		    <td width="15%" height="30"  class="info_title_01"><!-- 出差人选择  -->
	  <ait:message messageID="display.ess.attendance_request.biz_trip_request.employee"  module="ess"></ait:message>	    	    
		   </td>
		    ...
		    zhContent='<%=StringUtil.checkNull(essLeaveBean.getChineseName()) %>'
		      koContent='<%=StringUtil.checkNull(essLeaveBean.getKoreanname()) %>'></ait:content> 
		     &nbsp;]</td>                       
	 ...
	 <ait:message messageID="display.mutual.request_date"  module="ess"></ait:message>	    
	  ...
	  <ait:message messageID="display.mutual.start_time"  module="ess"></ait:message>	   	    
		  ...
		  <tr align="center">
		    <td height="30"  class="info_title_01"><!--出差类型  -->
	 <ait:message messageID="display.ess.attendance_request.biz_trip_request.type"  module="ess"></ait:message>		    	    
		    </td>
		    <td align="left">                                             
		     <ait:codeClass name="evectionTypeCode" codeClass="EvectionTypeCode"  />
		    <%-- 
		      <select name="evectionTypeCode"  style="width:85px ">
	  ...
	  <ait:message messageID="display.mutual.approver"  module="ess"></ait:message>					
		  ...
		  <%}%>
		  <tr>
			<td class="info_title_01" height="90px" nowrap="nowrap"><!-- 出差事由 -->
	  <ait:message messageID="display.ess.attendance_request.biz_trip_request.reason_for_business_trip"  module="ess"></ait:message>				
			</td>
