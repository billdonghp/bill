...
<input name="content" value="InfoApplyCertificateContentImp" type="hidden">
...
<table width="80%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  <tr align="center">
   ...
   <tr align="center">
    <td width="19%" height="30"  align="center" bgcolor="#F5F5F5">类型</td>
    <td width="28%" height="30"  align="left"><select name="qualificationType" style="width:140px ">
			<option value="">-------</option>
            <%
					try{
  ...
  <tr align="center">
    ...
    <td width="28%" height="30"  align="left"><input maxlength="100" type="text" name="qualificationInstitute"  style="width:140px "> </td>
    <td width="19%" height="30"  align="center" bgcolor="#F5F5F5">取证日期</td>
    <td width="34%" height="30"  align="left"><input type="text" name="qualificationDate" class="content"  style="width:140px ">&nbsp;<img src="/images/calendar/calender.gif" align="absMiddle" border="0" height="18" width="18" onClick="showCalendar('save','qualificationDate');" style="cursor:hand"></td>
  </tr>
</table>
</form>
</body>
