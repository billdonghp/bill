<%@ page contentType="text/html; charset=UTF-8" language="java" import="com.ait.util.*,com.ait.ess.dao.*,java.sql.*" errorPage="" %>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <td  height="30"  align="center"><%=militaryservice.getChineseName()%>&nbsp;</td>
    ...
    <td  height="30"  align="center"><font color="#CC0000"><%=militaryservice.getModifierID()%>&nbsp;通过</font></td>
    ...
    <td  height="30"  align="center"><font color="#CC0000"><%=militaryservice.getModifierID()%>&nbsp;未通过</font></td>
	        <%}%>
	<td  height="30"  align="center"><%if(militaryservice.getActivity()==0){%><a href="/ess/ess0600_t.jsp?menu_code=<%=menu_code%>&NO=<%=militaryservice.getMilitaryNo()%>&operate=militaryservice">删除</a><%}%>&nbsp;</td>
