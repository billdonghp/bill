  ...
  <tr>
    <td><table width="100%" border="1"
       ...
       <tr>      
        ...
        <c:forEach items="${applyLeaveDetail}" var="temp">
           <tr>
            ...
            <td   colspan="1" align="center" height="40"><c:out value='${temp.CHINESENAME}'/></td>
             <td   colspan="1" align="center" height="40"><c:out value='${temp.LEAVE_TYPE_NAME}'/></td>
             <td   colspan="2" align="center" height="40">
               <c:out value='${temp.BEGINTIME}'/><br>
               <c:out value='${temp.ENDTIME}'/>   
              </td>
            <td   colspan="4" align="center" height="40"><c:out value='${temp.LEAVE_REASON}'/></td>
           </tr>
        </c:forEach>                 
        <tr>
