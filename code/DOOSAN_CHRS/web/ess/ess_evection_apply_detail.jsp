...
<%
		...
		response.setHeader("Content-Disposition", "attachment; filename=evection.xls");
  ...
  <tr  height="50">
    <td colspan="9">             
	    <table width="100%">
	    	...
	    	<ait:message messageID="display.ess.attendance_request.biz_trip_request_report"  module="ess"></ait:message>
	    	 </td>
	    	</tr>
	      <tr>     
	    		 <td   height="30">&nbsp;</td>
  ...
  <tr align="center"> 
    <td	width="100%"><table width="100%" border="1"
       ...
       <tr>
        ...
        <tr>
          ...
          <td   height="50" colspan="2" align="center"><strong><!--  岗位职务 -->
    ...
    <td colspan="4"  align="center">
        ...
        <ait:message messageID="display.mutual.request_date"  module="ess"></ait:message>        
         ...
         <td  colspan="2"  align="center"><div align="center"><strong><!-- 出差类型 -->
        <ait:message messageID="display.ess.attendance_request.biz_trip_request.type"  module="ess"></ait:message>       
          </strong></div></td>
           <td  colspan="4"  align="center">
        <ait:content enContent='${applyLeaveDetail.LEAVE_TYPE_EN_NAME}'  zhContent='${applyLeaveDetail.LEAVE_TYPE_NAME}'></ait:content></td>     
        </tr>
        <tr>  
          <td   height="50" align="center"><div align="center"><strong><!--出差时段  -->
		...
		<tr>
        <td   height="50" rowspan="9" align="center"><div align="center"><strong><!-- 出差原因 -->
          <ait:message messageID="display.ess.review.biz_trip.reason"  module="ess"></ait:message>     
          </strong></div></td>
