	...
	<tr>
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		  <tr>
		    ...
		    <ait:message messageID="display.ess.review.training.trainee" module="ess"></ait:message>
		    </td>
		    ...
		    <ait:message messageID="display.ess.review.training.type" module="ess"></ait:message>
		    </td>
...
<!--		    <td class="info_title_01" nowrap>决裁情况</td>-->
		  ...
		  <tr align="center">
		   ...
		   <%-- 
		    <td class="info_content_01">
		    	<a href="/essControlServlet?operation=retrieveApplyTrainingDetail&menu_code=<%=menu_code%>&leaveNo=<%=essLeaveBean.getLeaveNo()%>" target="_blank">查看内容</a>
		    </td>
	...
	<input type="hidden" name="content" value="trainingview" />
