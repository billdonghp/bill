...
<form name="ApplyForm" action="/essControlServlet" method="post">
		  ...
		  <ait:message messageID="display.mutual.end_date" module="ess"></ait:message> 
		   ...
		   <ait:message messageID="display.mutual.key_word" module="ess"></ait:message>                
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1" >
				<tr>
					<td align="left" class="title1" colspan="10"><!--培训决裁 -->
		 <ait:message messageID="display.ess.approval.training.training_approval" module="ess"></ait:message>  	 
					</td>
				</tr>
			</table>
			<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
			  ...
			  <ait:message messageID="display.mutual.select_2" module="ess"></ait:message>  	   
			    ...
			    <td class="info_title_01" nowrap><!-- 培训人 -->
			      <ait:message messageID="display.ess.approval.training.trainee" module="ess"></ait:message>  	 
			    </td>
			    ...
			    <td class="info_title_01" nowrap><!-- 培训类型 -->
			   <ait:message messageID="display.ess.approval.training.type" module="ess"></ait:message>     
			    </td>
			    <td class="info_title_01" nowrap><!-- 倒休可用天数 -->
		  <ait:message
					messageID="display.mutual.hours_substitution" module="ess"></ait:message>  
		      </td>
			    <td class="info_title_01" nowrap><!--  培训时段-->
			    <ait:message messageID="display.ess.approval.training.period" module="ess"></ait:message>    
			    </td>
			    <td class="info_title_01" nowrap><!-- 培训原因 -->
	    ...
	    <ait:content enContent='<%=StringUtil.checkNull(essLeaveBean.getChinesePinYin()) %>'  
	       ...
	       koContent='<%=StringUtil.checkNull(essLeaveBean.getLeaveTypeKorName())%>'>         
			    ...
			    <td class="info_content_01" nowrap="nowrap">
			    	<a href="/essControlServlet?operation=retrieveApplyLeaveDetail&menu_code=<%=menu_code%>&leaveNo=<%=essLeaveBean.getLeaveNo()%>" target="_blank">
				...
				<td class="info_content_01" nowrap><textarea name="remark<%=affirmNo%>"><%=remark%></textarea></td>
			  </tr>
			<%}%>
			</table>
			...
			<c:if test="${fn:length(leaveList) < 7}">
				<c:forEach var="i" begin="1" end="${7-fn:length(leaveList)}" step="1">
					<tr>
	...
	<input type="hidden" name="content" value="trainingaffirm" />
