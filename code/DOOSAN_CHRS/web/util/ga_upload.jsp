...
function submitImp(){
 if(checkPotosExits()){
	...
	document.form1.action="/"+$('control').value+"?operation="+$('operation').value+"&content="+$('content').value+"&menu_code=${param.menu_code}&key="+$('key').value+"&jpgUpload="+$('jpgUpload').value;
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d" align="left">
	<tr>
		...
		<table id="operateTable" width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d" align="left">
			<tr>
				<td style="width: 500px" align="center"><font size="3" style="font-weight:900">上传图片</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
				<c:if test="${param.single!=1}">			
