...
function Calendar(whatMonth,whatYear) {
    ...
    output += '<td class="cal-HeadCell" align="center"  width="100%"><a href="javascript:clearDay();"><img name="calbtn1" src="/images/calendar/btn_del_small.gif" border="0" width="12" height="13"></a>&nbsp;&nbsp;<a href="javascript:scrollMonth(-1);" class="cal-DayLink"><img src="/images/calendar/back.gif" align=absmiddle border=0></a>&nbsp;<SELECT class="cal-TextBox" NAME="cboMonth" onChange="changeMonth();">';
    ...
    output += '<\/SELECT>&nbsp;<a href="javascript:scrollMonth(1);" class="cal-DayLink"><img src="/images/calendar/front.gif" align=absmiddle border=0></a>&nbsp;&nbsp;<a href="javascript:hideCalendar();"><img src="/images/calendar/close.gif" align=absmiddle border=0></a><\/td><\/tr><tr><td width="100%" align="center">';
...
var names     = new makeArray0('1月','2月','3月','4月','5月','6月','7月','8月','9月','10月','11月','12月');
