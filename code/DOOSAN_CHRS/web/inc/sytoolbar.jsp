    ...
    <td height="30" valign="middle">
	  <table width="99%" height="45" border="0" cellpadding="0" cellspacing="0">
        ...
        <td align="left" valign="middle" style="padding:3 0 3 0 ">
		  ...
		  <%if(insertMenu==1){%>
		  <a href="/sy/<%=menu_code%>_a.jsp?menu_code=<%=menu_code%>"><img src="/images/btn/add1.gif" width="67" height="24" border="0" align="absmiddle"> 
          </a><%}%><%if(updateMenu==1){%><a href="javascript:Update();" ><img src="/images/btn/modify1.gif" width="67" height="24" border="0" align="absmiddle"> 
          </a> <%}%><%if(deleteMenu==1){%><a href="javascript:Delete();" ><img src="/images/btn/delete1.gif" width="67" height="24" border="0" align="absmiddle"> 
          </a><%}%> 
          </a></td>
        </tr>
      </table>
