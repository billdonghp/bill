	  ...
	  <table width="99%" border="0" cellpadding="0" cellspacing="0">
        <tr>
         <td align="left" valign="middle" style="padding:3 0 3 0 ">
          ...
          <ait:image src="/images/btn/Bulk_Confirm.gif" align="absmiddle"
          	onclick="javascript:doBatchConfirm();" style="cursor:hand" />
          <ait:image src="/images/btn/Bulk_Reject.gif" align="absmiddle"
          	onclick="javascript:doBatchReject();" style="cursor:hand" />
