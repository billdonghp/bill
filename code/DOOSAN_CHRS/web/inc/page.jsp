...
<td align="left" ><table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	%>
		<td><a href="<%=menu_code%>.jsp?flag=list&bigpage=<%=bigpage%>&strPage=<%=i%>&search=<%= java.net.URLEncoder.encode(search,"UTF-8")%>&menu_code=<%=menu_code%>&selectContent=<%= content%>&selectCondition=<%=condition %>">
