...
function Save()
{
	...
	document.form1.action="/syControlServlet?operation=essLeaveParam_update&menu_code=${param.menu_code}" ;
	...
	<tr>
		...
		<table width="100%" border="1"cellspacing="0" cellpadding="5" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		  <tr>
		    ...
		    <td class="info_content_00"><ait:codeClass codeClass="LeaveTypeCode" name="APPLY_TYPE" selected="${result.APPLY_TYPE}" /></td>
		  ...
		  <tr>
		   ...
		   <td class="info_content_00">      
		    ...
		    <td width="10%" class="info_title_01">职号选择</td>
				<td class="info_content_00">
					<input id="empID" name="empID" size="8" value="${result.EMPID}" onKeyUp="SearchContent(this.value,this.id)"  />
