...
function check()
{
   id=document.PostXForm.gradeid.value;
    url = "/syControlServlet?operation=ispostgradeidexistcmd&postgradeid="+id+"&dowhat=add&menu_code=${param.menu_code}";
   location.href = url;                 
}                   
</SCRIPT>                         
</head>                                                 
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" >
		 ...
		 <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
			<tr>  
				...
				<input type="text" name="gradeid" align="left"  size="50"  maxlength="10" value="${postgradeid}" onblur="javascript:check();"/>  
			...
			<tr>                               
				 ...
				 <input type="text" name="postgradename"  maxlength="50" size="50"/>    
				 </td>
			</tr>
			<tr>     
			  ...
			  <ait:message messageID="display.name_english" ></ait:message>
				 ...
				 <td class="info_content_00" height="30"> 
				 <input type="text" name="postgradeenname"  maxlength="50"  size="50"/> 
				 </td>
			</tr> 
			<tr>     
