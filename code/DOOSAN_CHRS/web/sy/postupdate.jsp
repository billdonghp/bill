...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<TABLE width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
			<tr>
				<td class="info_title_01" width="15%" height="30"><!-- 岗位职务编号 -->
				 	<ait:message messageID="display.mutual.no" ></ait:message> 
				</td>
				<td class="info_content_00" width="85%" height="30"> 
				<input type="text" name="postno" align="left"  size="50"  maxlength="10" value="${simplemap.POST_NO}" readonly="readonly"/>    
			    </td>      
			</tr>                                     
			<tr>     
				 <td class="info_title_01"  height="30"> <!-- 岗位职务ID -->
					<ait:message messageID="display.mutual.id" ></ait:message>  
				 </td>  
				 <td class="info_content_00"  height="30"> 
				<input type="text" name="postid" align="left"  size="50"  maxlength="10" value="${simplemap.POST_ID}"  readonly="readonly"/>    
			    </td>     
			</tr> 
			<tr>                               
				 <td class="info_title_01"  height="30"><!-- 岗位职务名 --> 
				<ait:message messageID="display.name_chinese" ></ait:message>
				 </td>
				 <td class="info_content_00"  height="30"> 
				 <input type="text" name="postname"  maxlength="50" size="50"  value="${simplemap.POST_NAME}">    
				 </td>
			</tr>
			<tr>         
			 ...
			 <ait:message messageID="display.name_english" ></ait:message>  
				 ...
				 <td class="info_content_00"  height="30">   
				 <input type="text" name="postenname"  maxlength="50"  size="50"  value="${simplemap.POST_EN_NAME}"/> 
				 </td>  
			</tr>                   
			<tr>        
...
<input name="operation" value="updatepostcmd" type="hidden">                    
<input name="oldpostid" value="${simplemap.POST_ID}" type="hidden">   
