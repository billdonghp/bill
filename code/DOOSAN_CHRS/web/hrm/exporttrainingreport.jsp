  ...
  <tr>
    ...
    <td><table width="100%" border="1"
       ...
       <td align="center" height="40">结束日期</td>
        ...
        <td align="center" height="40" colspan="2">内容</td>
      </tr>
            ...
            <td align="center" height="40">${temp.CHINESENAME }</td>   
             ...
             <td align="center" height="40">${temp.STARTDATE }</td>   
             <td align="center" height="40">${temp.ENDDATE }</td>
                <td align="center" height="40">${temp.STUDYNAME }</td>
             <td align="center" height="40" colspan="2">${temp.STUDYCONTENTS }</td>
             </tr> 
             </c:forEach>
        </table>
        </td>
