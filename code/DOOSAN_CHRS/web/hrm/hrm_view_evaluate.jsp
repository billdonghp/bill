...
<jsp:useBean id="evaluate" class="com.ait.hrm.bean.Evaluate"
...
function Add(){                
	...
	document.form1.action="hrmControlServlet?menu_code=hr0103&operation=retrieveevaluateforinsertcmd&empID=<c:out value='${empID}'/>";
	document.form1.submit();
 }
  
function Update(){

	document.form1.action="hrmControlServlet?menu_code=hr0103&operation=retrieveevaluateforupdatecmd&empID=<c:out value='${empID}'/>";
	document.form1.submit();
}

function Delete(){  
	
	document.form1.action="hrmControlServlet?menu_code=hr0103&operation=retrieveevaluatefordeletecmd&empID=<c:out value='${empID}'/>";
	document.form1.submit();
}
...
<!--		<%@ include file="./inc/hrtoolbar_null.jsp"%>-->
	...
	<tr>
		...
		<!-- display basic info --> <%@ include file="./hrm_view_basic.jsp"%> 
