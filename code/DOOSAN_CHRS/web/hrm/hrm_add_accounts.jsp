...
function Save(){
	...
	document.form1.action="hrmControlServlet?menu_code=hr0111&operation=insertAccountsInfo&empID=<c:out value='${empID}'/>";
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						<td class="info_content_01" height="30" nowrap><input
							name="calcFlag" type="checkbox" value="Y" checked></td>
						<td class="info_content_01" nowrap><ait:codeClass
							name="bankAreaCode" codeClass="BANKAREA" all="ALL" /></td>
						<td class="info_content_01" nowrap><ait:codeClass
							name="bankNameCode" codeClass="BankNameCode" all="ALL" /></td>
						<td class="info_content_01" nowrap><input type="text"
							class="content" name="cardName" id="cardName"
							value="${basic.chineseName}" /></td>
						<td class="info_content_01" nowrap><input type="text"
							class="content" name="cardNo" id="cardNo" /></td>
				</table>
				</div>
				</td>
			</tr>
