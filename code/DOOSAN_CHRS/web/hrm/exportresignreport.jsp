...
<body>
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=resign.xls");
...
<table width="98%" border="0"  height="50" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="1"
       ...
       <td align="center" height="40" width="10%">所属部门</td>
       <td align="center" height="40" width="10%">岗位职务</td>
        <td align="center" height="40" width="10%">职位</td>
          <td align="center" height="40" width="10%">离职类型</td>
         <td align="center" height="40" width="10%">离职日期</td>
        <td align="center" height="40" colspan="3">离职事由</td>
      </tr>
         ...
         <c:forEach items="${list}" var="temp">   
            ...
            <td align="center" height="40">${temp.CHINESENAME }</td>   
             ...
             <td align="center" height="40">${temp.REGINTYPENAME }</td>   
             <td align="center" height="40">${temp.RESIGN_DATE }</td>
             <td align="center" height="40" colspan="3">${temp.RESIGN_DESC }</td>
              </tr> 
             </c:forEach>
        </table>
        </td>
