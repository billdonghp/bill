...
function HighLightTR(backColor,textColor,i,name,deptName,post,joinDate,dateLeft,idCard,passPort,position){
var t;
...
preEl.bgColor=orgBColor;
	...
	try{ChangeTextColor(preEl,orgTColor);}catch(e){;}
		...
		parent.document.getElementById("EmpId_").value=i;
		parent.document.getElementById("name").innerHTML=name;
		parent.document.getElementById("deptName").innerHTML=deptName;
		parent.document.getElementById("post").innerHTML=post;
		parent.document.getElementById("position").innerHTML=position;
		parent.document.getElementById("joinDate").innerHTML=joinDate;
		parent.document.getElementById("dateLeft").innerHTML=dateLeft;
		parent.document.getElementById("idCardOrPassport").innerHTML=idCard+passPort;
         ...
         <c:when test="${empListCnt > 0}">
				<c:forEach items="${empList}" var="oneResult">
					<c:if test="${admin.languagePreference == 'zh'}">
						<tr onClick="HighLightTR('#99CCFF','black','<c:out value="${oneResult.empID}"/>','<c:out value="${oneResult.chineseName}"/>','<c:out value="${oneResult.department}"/>','<c:out value="${oneResult.post}"/>','<c:out value="${oneResult.joinDate}"/>','<c:out value="${oneResult.dateLeft}"/>','<c:out value="${oneResult.idCard}"/>','<c:out value="${oneResult.passPort}"/>','<c:out value="${oneResult.position}"/>')" > 
					</c:if>
					<c:if test="${admin.languagePreference == 'en'}">
						<tr onClick="HighLightTR('#99CCFF','black','<c:out value="${oneResult.empID}"/>','<c:out value="${oneResult.pinyinName}"/>','<c:out value="${oneResult.englishDept}"/>','<c:out value="${oneResult.englishPost}"/>','<c:out value="${oneResult.joinDate}"/>','<c:out value="${oneResult.dateLeft}"/>','<c:out value="${oneResult.idCard}"/>','<c:out value="${oneResult.passPort}"/>','<c:out value="${oneResult.englishPosition}"/>')" > 
					</c:if>
