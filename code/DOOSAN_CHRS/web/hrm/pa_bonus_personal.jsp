...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<jodd:form fromRequest="true">
			...
			<input type="hidden" name="destination" value="pa_bonus_personal">
		...
		<table width="100%" height="30" border="0" cellpadding="0"
			...
			<tr align="center">
				...
				<tr align="center">
					...
					<a target="_blank" href='/pa/pa_bonus_personal_v.jsp?operation=hr_view&personId=${employee.personId}&info=basic&menu_code=${menu_code}&pamonth=${pamonth}&deptid=${employee.deptID}'>
