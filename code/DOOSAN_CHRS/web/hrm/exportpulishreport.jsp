...
<body>
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=publish.xls");
...
<table width="98%" border="0"  height="50" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="1"
       ...
       <td align="center" height="40" >惩戒日期</td>
       <td align="center" height="40">惩戒方式</td>
        <td align="center" height="40">违纪类型</td>
         <td align="center" height="40" colspan="2">惩戒事由</td>
            ...
            <td align="center" height="40">${temp.CHINESENAME }</td>   
             ...
             <td align="center" height="40">${temp.PUNISHMENTDATE }</td>   
             <td align="center" height="40">${temp.PUNISHMENTTYPENAME }</td>
              <td align="center" height="40">${temp.VIOLATIONTYPENAME }</td>
             <td align="center" height="40" colspan="2">${temp.PUNISHMENTCONTENTS }</td>
            </tr> 
             </c:forEach>
