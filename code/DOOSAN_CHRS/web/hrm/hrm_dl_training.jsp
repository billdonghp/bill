...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<form action="hrmControlServlet" method="post" name="searchForm" onkeydown="if(event.keyCode==13) searchForm.submit();">
		  ...
		  <input type="hidden" name="operation" value="viewTrainingCommand">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
		  ...
		  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
		  	<form name="save" action="hrmControlServlet" method="post">
				  <input type="hidden" name="operation" value="insertTrainingCommand"/>
				  <input type="hidden" name="menu_code" value="${toolbarInfo.menu_code}"/>
			  		 ...
			  		 <table width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d">
					  	<tr>
						  	...
						  	<td class="info_content_00" width="15%">
								<ait:codeClass style="content" codeClass="TransTraining" name="transCode"/>
							</td>
		  	...
		  	<tr>
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d">
				    <tr align="center">
				      <td class="info_title_01" height="30" nowrap="nowrap"><a href="#" onClick="checkAll();">
				      ...
				      <td class="info_title_01" nowrap="nowrap">
				      <!-- 研修类型 --><ait:message  messageID="display.emp.regulation_query.query_of_training.training_type" module="hrm"/></td>
				      <td class="info_title_01" nowrap="nowrap"><!-- 留学名 --><ait:message  messageID="display.mutual.title"/></td>
				      <td class="info_title_01" nowrap="nowrap"><!-- 专业 --><ait:message  messageID="display.mutual.major"/></td>
					  <td class="info_title_01" nowrap="nowrap"><!-- 国家 --><ait:message  messageID="display.emp.regulation_query.training.country" module="hrm"/></td>
				      <td class="info_title_01" nowrap="nowrap"><!-- 机关 --><ait:message  messageID="display.mutual.organization"/></td>
					  <td class="info_title_01" nowrap="nowrap"><!-- 费用 --><ait:message  messageID="display.emp.regulation_query.training.expenses" module="hrm"/></td>
				      <td class="info_title_01" nowrap="nowrap"><!-- 义务服期 --><ait:message  messageID="display.mutual.voluntary_work"/></td>
				    ...
				    <c:forEach items="${emp_list}" var="emp" varStatus="j">
					    <tr>
						  ...
						  <td class="info_content_01" nowrap="nowrap">${emp.empID}</td>
						  ...
						  <td class="info_content_01" nowrap="nowrap">
							<input style="content" type="text" size="10" id="endDate_${j.index}" name="endDate_${j.index}" 
						      		onClick="setday(this);setCheckboxChecked('selectedTag',${j.index});textMuli('endDate_',this.id)" 
						      		onChange="textMuli('endDate_',this.id)" 
						      		onBlur="textMuli('endDate_',this.id)"/> 
						  </td>
					      <td class="info_content_01" nowrap="nowrap">
						  	<ait:codeClass style="content"   codeClass="ResearchType" name="researchTypeCode_${j.index}" onChange="setCheckboxChecked('selectedTag',${j.index});selMuli('researchTypeCode_',this.id)"/>
						  </td>
					      <td class="info_content_01" nowrap="nowrap">
					      	<ait:codeClass style="content"   codeClass="StudyNameCode" name="studyTypeCode_${j.index}" onChange="setCheckboxChecked('selectedTag',${j.index});selMuli('studyTypeCode_',this.id)"/>
						  </td>
					      <td class="info_content_01" nowrap="nowrap">   
						   	<ait:codeClass style="content"   codeClass="SubjectCode" name="subjectCode_${j.index}" onChange="setCheckboxChecked('selectedTag',${j.index});selMuli('subjectCode_',this.id)"/>
						  </td>
					      <td class="info_content_01" nowrap="nowrap">
						   	<ait:codeClass style="content"  codeClass="NationalityCode" name="countryCode_${j.index}" onChange="setCheckboxChecked('selectedTag',${j.index});selMuli('countryCode_',this.id)"/>
						  </td>
					      <td class="info_content_01" nowrap="nowrap">
					      	<input style="content" type="text" size="15" id="institutionName_${j.index}" name="institutionName_${j.index}" 
								      		onChange="setCheckboxChecked('selectedTag',${j.index});textMuli('institutionName_',this.id)" />
					      </td>   
					      <td class="info_content_01" nowrap="nowrap">
					      	<input style="content" type="text" size="10" id="expense_${j.index}" name="expense_${j.index}" 
								      		onChange="setCheckboxChecked('selectedTag',${j.index});;textMuli('expense_',this.id)" />
					      </td>
					      <td class="info_content_01" nowrap="nowrap">
							<input style="content" type="text" size="10" id="period_${j.index}" name="period_${j.index}" 
						      		onClick="setday(this);setCheckboxChecked('selectedTag',${j.index});textMuli('period_',this.id)" 
						      		onChange="textMuli('period_',this.id)" 
						      		onBlur="textMuli('period_',this.id)"/>
						  </td>
						  <td class="info_content_01" nowrap="nowrap">
					      	<input style="content" type="text" size="20" id="studyContents_${j.index}" name="studyContents_${j.index}" 
								      		onChange="setCheckboxChecked('selectedTag',${j.index});textMuli('studyContents_',this.id)" />
					      </td>
					      </tr>
				  	</c:forEach>
...
<ait:page       
         ...
         parameters="&operation=viewTrainingCommand&menu_code=${toolbarInfo.menu_code}&DEPTID=${DEPTID}&CONDITION=${CONDITION}" 
         total="${resultCount}"
