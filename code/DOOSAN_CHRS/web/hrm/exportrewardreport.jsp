...
<body>
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=reward.xls");
...
<table width="98%" border="0"  height="50" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="100%" border="1"
       ...
       <td align="center" height="40" colspan="2">功绩内容</td>
       <td align="center" height="40">奖励类型</td>
        <td align="center" height="40">奖励金额</td>
       <td align="center" height="40" >发令生效日期</td>
      </tr>
            ...
            <td align="center" height="40">${temp.CHINESENAME }</td>   
             ...
             <td align="center" height="40" colspan="2">${temp.REWARD_CONTENTS }</td>
             <td align="center" height="40">${temp.REWARDTYPE }</td>
             <td align="center" height="40">${temp.REWARD_BONUS }</td>
             <td align="center" height="40">${temp.REWARD_DATE }</td>
              </tr> 
             </c:forEach>
