...
function Save()
{
  ...
  {//"请正确输入2位分钟时间"
	...
	document.form1.action="/arControlServlet?operation=insertEateryRecord&menu_code=${param.menu_code}";
		...
		<form name="form1" method="post" action="">
		  ...
		  <table width="100%" border="1"cellspacing="0" cellpadding="5" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		    ...
		    <tr>
		      ...
		      <td class="info_content_00"><ait:codeClass name="REPAST_TYPE" codeClass="RepastType"/></td>
		    </tr>
		    <tr>
