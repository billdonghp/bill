...
function Save()
{
	...
	document.form1.action="/arControlServlet?operation=aritemadd&menu_code=<%=request.getParameter("menu_code")%>";
		...
		<form name="form1" method="post" action="">
		  ...
		  <table width="100%" border="1"cellspacing="0" cellpadding="5" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		    ...
		    <tr>
		      ...
		      <input name="itemId" type="text" value="${arItem.itemId}" size="30" maxlength="29" required  />&nbsp;&nbsp;项目ID长度不能大于30个字符,单词之间以_相连</td>
		    </tr>
		    <tr>
		      <td width="15%" class="info_title_01" align="center"><!-- 全名称-->
					<ait:message  messageID="display.att.setting.items.edit.name_chinese" module="ar"/></td>
		      <td width="75%" class="info_content_00">
		      <input name="itemName" type="text" value="${arItem.itemName}" size="30" maxlength="25" required />&nbsp;<c:if test="${error == 'error'}"> <FONT color="red">添加失败,${arItem.itemName},与其他项目的开始文字重复</FONT> </c:if></td>
		    </tr>
		    <!-- 英文名称-->
		    <!--  
		    <tr>
		      ...
		      <td class="info_content_00"><input name="itemEnName" type="text" size="10" maxlength="10" required /></td>
		    </tr>
		   -->
		   <!-- 韩文名称-->
		   <!--  
		    <tr>
		      ...
		      <td class="info_content_00"><input name="itemKorName" type="text" size="10" maxlength="10" /></td>
		    </tr>
		  -->
		    <tr>
		      <td class="info_title_01"><!-- 简称-->
					<ait:message  messageID="display.att.setting.items.abbreviation" module="ar"/></td>
		      <td class="info_content_00"><input name="shortName" type="text" value="${arItem.shortName}" size="30" maxlength="25" required /></td>
		    </tr>
		    <tr>
		      <td class="info_title_01"><!-- 项目组-->
					<ait:message  messageID="display.att.setting.items.group" module="ar"/></td>
		      <td class="info_content_00"><ait:codeClass codeClass="ArItemGroup" name="itempGroupCode" disabled="false" selected="${arItem.itemGroupCode}"/></td>
		    </tr>
		    <tr>
		    ...
		    <tr>
		      ...
		      <td class="info_content_00"><textarea name="description" cols="30" rows="3">${arItem.description}</textarea></td>
		    </tr>
		  </table>
		</form>
