...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" height="30" border="0" cellpadding="0" cellspacing="1" class="dr_d">
			<tr>
				<td class="info_title_01" width="15%">
				所属年份
				</td>
				...
				<td class="info_content_00" width="10%">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" >
		 ...
		 <table width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d">
			...
			<tr bgcolor="#FFFFFF" onClick="HighLightTR('#E7F0EF','black','${VCtr.POST_GRADE_ID}','${VCtr.POST_GRADE_YEAR}')">
