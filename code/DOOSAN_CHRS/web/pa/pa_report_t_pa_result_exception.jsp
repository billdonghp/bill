...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=t_pa_result_exception.xls");
...
<%			
		...
		List resultList = services.retrieveTPaResultExceptionDataList(parameterObject) ;
