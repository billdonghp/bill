...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<form method="post" name="sf" action="/paControlServlet?operation=pa_bonus_item_add&search=${param.search}&currentPage=${param.currentPage}&menu_code=${param.menu_code}" onSubmit="return CheckForm()">
		<tr>
		<td height="26" width="15%" class="info_title_01">法人区分</td>
		<td  width="85%" class="info_content_00"><ait:codeClass codeClass="EMP_DIFF" name="cpnyId" all="all"/></td>
		</tr>
		<tr>
