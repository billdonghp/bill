...
response.setHeader("Content-Disposition", "attachment; filename=pa_detailMonth.xls");
response.setHeader("Pragma", "public");
response.setHeader("Cache-Control", "max-age=0"); 
%>
<table width="100%"  border="1" cellpadding="1" cellspacing="1" >
<tr><td align="left" colspan="43">
...
<table width="100%"  border="1" cellpadding="1" cellspacing="1" >
    <tr bgcolor="#CCCCCC">
        ...
        <td align="center"  rowspan="2"><b>职责津贴</b></td>
    ...
    <tr bgcolor="#CCCCCC" height="20">
	 ...
	 <c:forEach items="${recordList}" var="list" varStatus="i">	
	    <tr>  
	     	...
	     	<td align="center">${list.JOB_ALLOWANCE}</td>
	  ...
	  <c:forEach items="${recordListsum}" var="listsum" varStatus="s">	
	    <tr bgcolor="#CCCCCC">  
	     	...
	     	<td align="center">${listsum.JOB_ALLOWANCE}</td>
	     	<td align="center"> </td>
	     	<td align="center"> </td>
