...
ID='';
function Add(){
	location.href="/pa/pa_param_item_add.jsp?menu_code=${param.menu_code}";
}
function Update(){
	if (ID!=''){
		location.href="/pa/pa_param_item_update.jsp?menu_code=${param.menu_code}&param_no="+ID;
	}
	else{
	//"请选择参数"
...
function Search(){
	document.form1.action="/paControlServlet?operation=paParamList&menu_code=${param.menu_code}";
