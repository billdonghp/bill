			...
			<tr>  
				...
				<ait:message messageID="display.mutual.id" ></ait:message>
				 ...
				 <td class="info_content_00" width="85%" height="30"> 
					<select name="gradeid" onchange=" changePostGradeName(this)">
						<option value="">请选择</option>
				
						<c:forEach var="postGrade" items="${postGradeTypeList}" varStatus="i">
							<option value="${postGrade.POST_GRADE_ID}">${postGrade.POST_GRADE_NAME}</option>
						</c:forEach>
					</select>
			    </td>     
			</tr>       
