...
function Add()
	{
	  document.LGFORM.action="/evsControlServlet?operation=evstypeopaadd&menu_code=<%=request.getParameter("menu_code")%>";
	  document.LGFORM.submit();
	}
</script>
...
<table width="100%" border="0"   cellpadding="0"
	...
	<tr>
		...
		<td background="../images/tablbk01_r1_c2.gif">
			<!-- display toolbar -->
 		<%@ include file="../evs/inc/evs0133toolbar_v.jsp"%>  
		</td>
	      ...
	      <td >
	      	<table width="100%" height="30" border="0" cellpadding="0"
				cellspacing="1" class="dr_d">
	       		 <tr>
	       		 	<td class="info_title_01" width="80">作业类型</td> 
					...
					<input type="hidden"
						...
						<input type="hidden"
						name="codeflag" value="TO">
					<select name="code_name" id = "code_name"
						onchange="Save()">
						<option value='' <%if(code_name.equals("")){out.print(" selected ");}%>>作业类型</option>
						<%
					List lEvcodename = evscraft.getEvsTypeOpacodeList();
					if(lEvcodename!=null){
	 ...
	 <tr>
		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<tr align="center" onClick="HighLightTR('#F0F1F4','black','','')">
				...
				<div align="center">作业类型ID</div>
				</td>
				<td width="15%" class="info_title_01">
				<div align="center">作业类型名称</div>
				</td>
				<td width="15%" class="info_title_01">
				<div align="center">作业类型英文名称</div>
				</td>
				 <td width="15%" class="info_title_01">
				...
				<div align="center">添加者</div>
				 ...
				 <td width="35%" class="info_title_01">
	            ...
	            <%
	                if(code_name!=null)
	                {
					  List levStypecodeid=evscraft.getEvsTypeOpaCodename(code_name);
					  if(levStypecodeid!=null){ 
					     for(int i=0;i<levStypecodeid.size();i++){
					        evscraft=(EvsCraft)levStypecodeid.get(i);
