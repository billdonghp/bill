...
<title>技能评价 > 基本设置 > 职业资格等级设置</title>
    	 ...
    	 if (status=='2')
    	    {
    	    	...
    	    	// alert(ID)
    	        document.form1.action="/evsControlServlet?operation=evszyzgdjupdate&evscodeid="+ID+"&menu_code=<%=request.getParameter("menu_code")%>";
...
function Add()
	{
	  document.LGFORM.action="/evsControlServlet?operation=evszyzgdjadd&menu_code=<%=request.getParameter("menu_code")%>";
	  document.LGFORM.submit();
	}
function Delete()
{
	      	...
	      	<table width="100%" height="30" border="0" cellpadding="0"
				cellspacing="1" class="dr_d">
					...
					<select name="code_name1"
						...
						<option value='' <%if(code_name1.equals("")){out.print(" selected ");}%>>职业资格</option>
						<%
					List lEvstypecodename = evsGxjndj.SelectEvsZyzgdj(code_name);
		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<tr align="center" onClick="HighLightTR('#F0F1F4','black','','')">
	            ...
	            <%
	                if(code_name!=null)
	                {
					  List levStypecodeid=evsGxjndj.getEvsDJCodename(code_name,code_name1);
				 ...
				 %>
						<tr
							...
							<td>
							<div align="center" height="30" ><%=evsGxjndj.getEvscodeid()%>&nbsp;
