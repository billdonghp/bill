                        ...
                        <td width="7">
                            ...
                            <td width="3">
                                <td width="527" align="right" valign="middle" style="padding:3 0 3 0 ">
                                    <img name="addbtn" id="addbtn" src="/images/ev/add.gif" border="0" onclick="window.open('evsdetailadd.jsp?EmpID=&evPeriod=&Action=add','detailadd','toolbar=no,location=no,directory=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=no,width=760,height=400,left=10,top=0')"" style="cursor:hand;visibility:"  alt="添加"/>
