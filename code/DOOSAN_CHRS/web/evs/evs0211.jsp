...
String evProcessId=Constants.EVPROCESS007;
List lEvsDept=null;
...
%>
<%@ include file="inc/evstoolbar_0211.jsp"%>
...
<form action="/evs/evs0211.jsp?menu_code=evs0211" method="Post" name="searchForm">
...
<form action="/evs/evs0211_t.jsp?menu_code=evs0211" method="Post" name="save" >     
        ...
        <tr align="center">
             ...
             --%><%
	           ...
	           for(int k=0,m=lPreMaster.size();k<m;k++){
	        	...
	        	if(null!=lPreEvsProcess&&lPreMaster.size()==0){
		           for(EvsProcess ep:lPreEvsProcess){
