...
function Save()
{
  document.LGFORM.action="/evsControlServlet?operation=evsGjjsdjsave2&menu_code=<%=request.getParameter("menu_code")%>";
	 ...
	 <form name="LGFORM" action="" method="POST" >
       ...
       <input type="hidden" name="menu_code" value="<%=menu_code%>">
		  ...
		  <table width="100%" border="1"cellspacing="0" cellpadding="10" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		    <tr>
		      <td width="15%" class="info_title_01">工匠技师姓名</td>
		      <td width="75%" class="info_content_00">${searchLine.CHINESENAME}</td>
		      <input type="hidden" name="codeno"  value="${searchLine.CODE_NO}"/>
		    </tr>
		    <tr>
		      <td class="info_title_01">评价年度  </td>
		         <td width="75%" class="info_content_00">${searchLine.EV_PERIOD_ID}</td>
		  </tr>
		    <tr>
		      <td class="info_title_01">工种      </td>
		    ...
		    <tr>
		      ...
		      <input name="pjwd1" type="text" size="20" value="${searchLine.PJWD1}"></td>
		    </tr>
		     <tr>
		      <td width="15%" class="info_title_01">评价维度2</td>
		      <td width="75%" class="info_content_00">
		      <input name="pjwd2" type="text" size="20" value="${searchLine.PJWD2}"></td>
		    </tr>
		     <tr>
		      <td width="15%" class="info_title_01">评价维度3</td>
		      <td width="75%" class="info_content_00">
		      <input name="pjwd3" type="text" size="20" value="${searchLine.PJWD3}"></td>
		    </tr>
		     <tr>
		      <td width="15%" class="info_title_01">评价维度4</td>
		      <td width="75%" class="info_content_00">
		      <input name="pjwd4" type="text" size="20" value="${searchLine.PJWD4}"></td>
		    </tr>
		    
		     <tr>
		      <td width="15%" class="info_title_01">总分</td>
		      <td width="75%" class="info_content_00">
		      <input name="sumstore" type="text" size="20" value="${searchLine.SUMSTORE}"></td>
		    </tr>
