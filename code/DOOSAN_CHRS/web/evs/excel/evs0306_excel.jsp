...
<body>
<%
response.setHeader("Content-Disposition", "inline; filename=evsItem.xls");
...
<table width="100%" border="1" align="right" cellpadding="1"
	...
	style="padding: 2px 2px 2px 2px;">
		<tr bgcolor="#F5F5F5"　>
		<td colspan="11"><font style="bold"><strong>部门:<%=evsEmp.getEvDeptName()%>		姓名:<%=evsEmp.getEvEmpName()%></strong></font></td>
	</tr>
	<tr bgcolor="#F5F5F5">
...
%>
		...
		--><%}else{
		no_count++;%>
		<td colspan="11"><font color="red">目标未录入！</font></td>	
		<%
		}
	...
	<tr>
		...
		<%}else{%>
		<td colspan="9"><font color="red">无！</font></td>	
		<%}%>
	</tr>
	<%}%>
</table>
