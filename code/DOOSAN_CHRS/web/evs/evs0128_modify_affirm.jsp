...
function doAffirm(flag){
  ...
  if (!existSelected){
	...
	///	alert("3");
		...
		document.ApplyForm.action="/evsControlServlet?operation=evszGxupdateaffirm&menu_code=<%=request.getParameter("menu_code")%>";
		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<ait:message	messageID="display.mutual.status_2" module="ess"></ait:message>   
	            ...
	            <%
					  ...
					  List levStypecodeid=evsGxjndj.getEvsGXCodenameconfirm(parameterObject);
				 ...
				 %>
						<tr
							...
							<td><div align="center" height="30" ><%=evsGxjndj.getDjjffrom1()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evsGxjndj.getDjjffrom()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evsGxjndj.getDengji()%>&nbsp;</div>
							</td>
							
							<td><div align="center" height="30" ><%=evsGxjndj.getEvscodeid()%>&nbsp;</div>
							</td>
							<td>
					      		  <table>
							      <tr>  
							      <td align="center">
							       <span style="color: green">  <%=evsGxjndj.getDescriptio()%>(现) </span>
							      </td>
							      </tr>	
							       <tr>  
							        <td align="center">  
							        <span style="color: blue">    <%=evsGxjndj.getDescriptio1()%>(原) </span>
							      </td>
							      </tr>	  
							      </table>	  	
					        </td>
