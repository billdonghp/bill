...
function doAffirm(flag){
  ...
  if (!existSelected){
	...
	///	alert("3");
		...
		document.ApplyForm.action="/evsControlServlet?operation=evsSetupcodeaffirm&menu_code=<%=request.getParameter("menu_code")%>";
		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<tr align="center" onClick="HighLightTR('#F0F1F4','black','','')">
			 <td class="info_title_01" width="20"><a href="#" onclick="checkAll();" style="color:red;"> <!-- 全选 -->
			  <ait:message messageID="display.mutual.select_2" module="ess"></ait:message>  	   
				...
				<td class="info_title_01" nowrap>决裁类型</td>      
			...
			<ait:message	messageID="display.mutual.status_2" module="ess"></ait:message>   
	            ...
	            <%
					  ...
					  List levStypecodeid=evsGxjndj.getEvsSetupCodeconfirm(parameterObject);
				 ...
				 %>
						<tr
							onClick="HighLightTR('#F0F1F4','black','<%=evSupcode.getPkNo1()%>','<%=menu_code%>')">
							 <td class="info_content_09" ><%if (evSupcode.getSTATUS().equals("2") ) {%>
							 	<input type="checkbox" name="affirmNo" value="<%=affirmNo%>" <%=checkState%>>
							  	 <input type="hidden" name="applyNo<%=affirmNo%>" value="<%=applyNo%>">
							  	 <input type="hidden" name="codeflag<%=affirmNo%>" value="<%=evSupcode.getCodeflag()%>">
							...
							<td><div align="center" height="30" ><%=evSupcode.getChineseName()%>&nbsp;</div>
							</td>
							
							<td><div align="center" height="30" ><%=evSupcode.getCRAFT()%>&nbsp;</div>
							</td>
							
							<td><div align="center" height="30" ><%=evSupcode.getLINE()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getJOBCONTENT()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getPROVEDATE()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getPROFICIENCY()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getSTANDARDACTION()%>&nbsp;</div>
							</td>
							
							<td><div align="center" height="30" ><%=evSupcode.getOPERATIONCOM()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getQUALITYOFWORK()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getCOMPOSITE()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getSKILLLEVEL()%>&nbsp;</div>
							</td>
							
							<td><div align="center" height="30" ><%=evSupcode.getDescriptio()%>&nbsp;</div>
							</td>							
							<td><div align="center" height="30" ><%=evSupcode.getSKILLSCORE()%>&nbsp;</div>
							</td>							
							<td><div align="center" height="30" ><%=evSupcode.getSUMSCORE()%>&nbsp;</div>
							</td>							
							<td><div align="center" height="30" ><%=evSupcode.getREMARK()%>&nbsp;</div>
							</td>							
							<td><div align="center" height="30" ><%=evSupcode.getPROVEBY()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getCONFIRMDATE()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getSHEOPERCYQ()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getPURPOSE()%>&nbsp;</div>
							</td>
							<td><div align="center" height="30" ><%=evSupcode.getCodeflag()%>&nbsp;</div>
							</td>
