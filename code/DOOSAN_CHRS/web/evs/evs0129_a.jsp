...
function Save()
{
  ...
  document.LGFORM.action="/evsControlServlet?operation=evsstypesave&menu_code=<%=request.getParameter("menu_code")%>";
		    ...
		    <tr>
		      <td class="info_title_01"><!-- 工序-->
		        ...
		        <td class="info_content_00"> 
		            ...
		            <c:forEach items="${searchExpiredLine}" var="EVSCT"
					    varStatus="s">
							 <input
								type="checkbox" name="isChecked" value="${EVSCT.CODE_ID}"
								class="check" /> 
							 ${EVSCT.CODE_NAME}
					</c:forEach>
		        </td>
