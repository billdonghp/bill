		...
		<table width="99%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="right" valign="middle"
					...
					<%if(insertMenu==1){%>
					<img src="/images/btn/add1.gif" width="67"
					height="24" border="0" align="absmiddle"
					onclick="javascript:Add();" style="cursor:hand"
					>
					<%}%>
					<%if(updateMenu==1){%>
					<img src="/images/btn/modify1.gif"
					width="67" height="24" border="0" align="absmiddle"
					onclick="javascript:Modify();" style="cursor:hand"
					>
					<%}%>
					<%if(deleteMenu==1){%>
					<img src="/images/btn/delete1.gif"
					width="67" height="24" border="0" align="absmiddle"
					onclick="javascript:Delete();" style="cursor:hand"
					>
					<%}%>
					</td>
			</tr>
