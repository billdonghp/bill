...
<form name="LGFORM" method="POST" action="/evs/<%=menu_code%>_t.jsp" >
		...
		<table width="99%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="right" valign="middle"
					...
					<img name="defaultbtn" id="defaultbtn" src="/images/ev/save.gif" border="0" onClick="javascript:save1();" style="cursor:hand;visibility:"  alt="保存" />
					<img name="submitbtn" id="submitbtn" src="/images/ev/submit.gif" border="0" onClick="javascript:submit1();" style="cursor:hand;visibility:"  alt="同意/提交" /></td>
			</tr>
		</table>
		</td>
	</tr>
