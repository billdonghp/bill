...
function Save()
{	
    document.form1.action="/gaControlServlet?operation=updateClothing&menu_code=${param.menu_code}";
	...
	<tr>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td class="info_content_00">
					<ait:codeClass name="UNIT" codeClass="ClothingUnit" selected="${result.UNIT}"/>
				</td>
			</tr>
			<tr>
