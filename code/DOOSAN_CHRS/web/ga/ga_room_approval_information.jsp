...
<html>
<head>
<!-- ga_room_approval_information.jsp -->
...
document.form1.submit();
 ...
 function Delete(applyno){
    ...
    if(confirm("确认删除该记录吗？")){
      document.form1.content="/puControlServlet?menu_code=ga0401&operation=conferenceRoom&content=Delete&applyno="+applyno;
      document.form1.submit();
      }else{
       return ;
      }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table width="100%" height="30" border="0" cellspacing="1" cellpadding="0" >
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		    ...
		    <tr height="30">
		      <td nowrap="nowrap" align="center"  style="color: #666666;">${varTest.CONFERENCENO}</td>
		      ...
		      <td nowrap="nowrap" align="center"  style="color: #666666;">${varTest.DEPTNAME}</td>
		      <td nowrap="nowrap"  align="center" style="color: #666666;">${varTest.CHINESENAME}</td>
		      <td nowrap="nowrap" align="center"  style="color: #666666;">${varTest.PEOPLECLASS}</td>
		      <td nowrap="nowrap" align="center"  style="color: #666666;">${varTest.PEOPLECLASS_UP}</td>		      
		      <td nowrap="nowrap" align="center"  style="color: #666666;">${varTest.BOOKNUMBER}</td>
		      <td nowrap="nowrap" align="center"  style="color: #666666;">${varTest.ROOMNAME}
			  </td>
			  <td nowrap="nowrap"  style="color: #666666;" id = 'equips${varTest.APPLYNO}'>
		      ...
		      <td nowrap="nowrap" align="center"  style="color: #666666;">
		      <c:if test="${varTest.ISCONFIRM  ne '1'}">
		      <a href="/puControlServlet?menu_code=ga0401&operation=conferenceRoom&content=Delete&applyno=${varTest.APPLYNO}" onclick="return(confirm('确认删除吗？这将清空所有的相关信息！'))"><font color="red">删除</font></a>
		     </c:if>
		      </td>
		   ...
		   <input type="hidden" name="currentPage" value="${currentPage}">
					...
					<ait:page       
		               ...
		               parameters="&menu_code=ga0401&operation=conferenceRoom&content=conferenceRoomConfirm&fa=1&startDate=${startDate}&endDate=${endDate }&qryType=${qryType}" 
		               total="${resultCount}"
