...
function Search(){
	...
	document.ApplyForm.action="/gaControlServlet?operation=retrieveWashApplyInfo&menu_code=${param.menu_code}";
	document.ApplyForm.submit();
}

function ImportExcel() {
    document.ApplyForm.action="/gaControlServlet?operation=retrieveWashApplyInfo&menu_code=${param.menu_code}&excelFlag=excel";
   	document.ApplyForm.submit();
...
function Delete(applyNo){
	...
	if (confirm("确定对当前记录进行删除？")) {
		document.ApplyForm.action="/gaControlServlet?operation=deleteWashApply&menu_code=${param.menu_code}";
		document.ApplyForm.submit();
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
			...
			<tr>
				...
				<table width="100%" height="30" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="12%" class="info_content_00"><!-- 请输入姓名查找 --> <input
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td align="left" class="title1" colspan="10">洗衣情况</td>
			</tr>
		</table>
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<c:forEach items="${recordList}" var="oneResult" varStatus="i">
				<tr align="center">
					...
					<td class="info_content_01">
					&nbsp;
						<c:if test="${oneResult.CONFIRM_FLAG == 0 && oneResult.CREATED_BY eq adminID}">
