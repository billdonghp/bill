...
<jsp:useBean id="admin" class="com.ait.sy.bean.AdminBean"
	scope="session" />
<jsp:useBean id="eatType" class="java.util.ArrayList" scope="request" />
<jsp:useBean id="eatTypeSize" class="java.lang.String" scope="request" />
<jsp:useBean id="foodType" class="java.util.ArrayList" scope="request" />
...
function Save() {
   var eatery = document.getElementsByName("eatType");   
   var eaterynum=0;
   var eateryName="";
   for(var i=0; i<eatery.length;i++){
    if(eatery[i].checked==true){
     eaterynum=eaterynum+1;
     eateryName += document.getElementById(eatery[i].value).value+",";
    }
   }
   document.form1.eateryName.value = eateryName;
        if(document.form1.starttime.value==""||document.form1.starttime.value==null||document.form1.endtime.value==""||document.form1.endtime.value==null){
		   ...
		   alert("结束时间必须在开始时间之后");
		    return;
		}else if(document.form1.used.value==""||document.form1.used.value==null){
			 alert("使用人不能为空！");
			 return;
		}else if(document.form1.peoples.value==""||document.form1.peoples.value==null){
			 alert("用餐人数不能为空");	
			 return;	
		}else if(eaterynum==0){
		     alert("未选择就餐类型");
		 ...
		 return;
			...
			if(confirm("是否提交申请!!!")){
				//alert(123) ;
				document.form1.action="/gaControlServlet?operation=gaApply&content=cardApplicationAdd&menu_code=${param.menu_code}";
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" >
			<tr>
				...
				就餐申请<font color="red" size="2">${declaration}</font>
				</td>
			</tr>     
		</table>
		<%if (!errorMsg.equals("")) {%>
		...
		<%}%>
						<table width="100%" border="1" cellspacing="0" cellpadding="0"
							...
							<tr>
								...
								<td nowrap="nowrap"  class="info_content_00" >
									<ait:codeClass codeClass="Food_Type" name="foodType" />
								</td>
								<td nowrap="nowrap" class="info_title_01">
									职号
								</td>
								...
								<td nowrap="nowrap" class="info_content_00">
									<input type="text" style="width: 80px" id="key"
										 value="${key}"  title="没有职号时，不用输入"  onKeyUp="SearchEmp(this.value,this.id)"/>
								</td>
							...
							<tr>
								...
								<td nowrap="nowrap"  class="info_content_00" >
									<input type="text" name="peoples" id="peoples" value=""
								...
								<td nowrap="nowrap" class="info_content_00">
									<input type="text" style="width: 80px" name="used" id="used"
										value="" />
								...
								<td nowrap="nowrap" class="info_content_00">
									<input type="text" style="width: 80px" name="jobtitle"  value="" />
								</td>
								<td nowrap="nowrap" class="info_title_01">
									来访单位
								</td>
								<td nowrap="nowrap"  class="info_content_00" >
									<input type="text" style="width: 80px" name="company"
										id="company" value="" />
								</td>							
							...
							<tr >
								...
								<input type="hidden" name="eateryName" value="">
									<c:forEach items="${eatType}" var="all" varStatus="i">
	      				${all.GM_TYPE}<input type="checkbox"
											name="eatType" value="${all.GM_ID}"/>
								...
								<td nowrap="nowrap" class="info_content_00" colspan="3">
									<textarea name="Remarks" style=" height: 40px;width:300px "
								...
								<td nowrap="nowrap" class="info_content_00" colspan="3">
									<textarea name="TJSX" style=" height: 40px;width:300px "
										type="_moz" onfocus="this.style.height='60px'"
										onblur="this.style.height='40px';"></textarea>
								</td>
