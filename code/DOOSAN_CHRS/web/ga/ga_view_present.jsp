...
function search(){
	...
	$('SEQ_NO').value = "";
	document.ApplyForm.action="/gaControlServlet?operation=retrievePresentList&menu_code=${param.menu_code}";
	document.ApplyForm.submit();
}

function Add() {
	document.ApplyForm.action="/ga/ga_add_present.jsp?menu_code=${param.menu_code}&cpnyId="+document.ApplyForm.cpnyId.value;
	document.ApplyForm.submit();
}
function Update() {
	...
	document.ApplyForm.action="/gaControlServlet?operation=retrieveDataForUpdatePresent&menu_code=${param.menu_code}";
	document.ApplyForm.submit();
}
function Delete() {
	if(document.ApplyForm.SEQ_NO.value=="") {
	...
	if(confirm('确定删除吗？')){
		document.ApplyForm.action="/gaControlServlet?operation=deletePresent&menu_code=${param.menu_code}";
		document.ApplyForm.submit();
	}
}
				...
				<table width="100%" height="30" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="15%" class="info_content_00"><ait:codeClass
							name="presentId" codeClass="PresentName" cpnyId="${cpnyId}" selected="${presentId}"
							all="all" /></td>
