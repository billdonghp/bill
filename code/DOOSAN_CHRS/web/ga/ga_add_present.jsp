...
{	
    ...
    document.form1.action="/gaControlServlet?operation=insertPresent&menu_code=${param.menu_code}";
		...
		<table id="tableObj" width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td class="info_content_00">
					<ait:codeClass name="PRESENT_TYPE" codeClass="PresentType" cpnyId="<%=cpnyId%>" onChange="toggle(this.value);" all="all"/>
				</td>
			</tr>
			<tr>
				...
				<div id="id1" style="display:none">
					<ait:codeClass name="PRESENT_ID1" codeClass="PresentMarried" cpnyId="<%=cpnyId%>" onChange="getPresentInfo();" all="all"/>
		         </div>   
		         <div id="id2" style="display:none">
					<ait:codeClass name="PRESENT_ID2" codeClass="PresentName" cpnyId="<%=cpnyId%>" onChange="getPresentInfo();" all="all"/>
		         </div>    
		         <div id="id3">
					<ait:codeClass name="PRESENT_ID3" codeClass="PresentName" cpnyId="<%=cpnyId%>" onChange="getPresentInfo();" all="all"/>
		         </div>  
				</td>
			</tr>
			<tr>
