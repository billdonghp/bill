...
function Save() {
	...
	document.form1.action="/gaControlServlet?operation=applyPresentYtgl&menu_code=${param.menu_code}";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td align="left" class="title1" colspan="10">管理部礼品申请<font color="red" size="2">${declaration}</font></td>
			</tr>
		</table>
				...
				<td nowrap="nowrap" class="info_content_00">
					<%if(!affirmList.isEmpty()){%>
								...
								<%									
									...
									if ("朴赞赫".equals(gaAffirmList.getAffirmorName())||"高旻槿".equals(gaAffirmList.getAffirmorName())){
								 %>
		...
		<table id='operateTable' width="100%" border="1" cellspacing="0"
			...
			<tr>    
				...
				<td nowrap="nowrap" class="info_content_01">
					<ait:codeClass name="PRESENT_TYPE_0" codeClass="PresentType" cpnyId="78888888" onChange="toggle(this.value);" all="all"/>
				</td>
				<td nowrap="nowrap" class="info_content_01">
				<div id="id1" style="display:none">
					<ait:codeClass name="PRESENT_ID1_0" codeClass="PresentMarried" cpnyId="78888888" onChange="getPresentInfo(0);" all="all"/>
					<span style="color:red; cursor:pointer;" onClick="ScenePhotos(this)" title="查看礼品照片">查看照片</span>
		         </div>   
		         <div id="id2" style="display:none">
					<ait:codeClass name="PRESENT_ID2_0" codeClass="PresentName" cpnyId="78888888" onChange="getPresentInfo(0);" all="all"/>
					<span style="color:red; cursor:pointer;" onClick="ScenePhotos(this)" title="查看礼品照片">查看照片</span>
		         </div>   
		         <div id="id3">
					<ait:codeClass name="PRESENT_ID3_0" codeClass="PresentName" cpnyId="78888888" onChange="getPresentInfo(0);" all="all"/>
					<span style="color:red; cursor:pointer;" onClick="ScenePhotos(this)" title="查看礼品照片">查看照片</span>
		         </div>  
				</td>
