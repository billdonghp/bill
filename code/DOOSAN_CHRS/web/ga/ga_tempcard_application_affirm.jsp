...
<SCRIPT type="text/javascript">
 ...
 function search(){
 document.form1.action="/gaControlServlet?menu_code=ga0213&operation=gaAffirm&content=temporarycardApplicationAffirm";
 ...
 function doAffirm(){ 
   ...
   if(!selectFlag){
          ...
          document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=gaAffirm&content=batchTempCardAffirm&affirmFlag=1";
		  document.form1.submit();
   }
 ...
 function doReject(){
   if(confirm("确认对已选择的信息进行否决吗？")){  
	   ...
	   if(!selectFlag){
			  ...
			  document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=gaAffirm&content=batchTempCardAffirm&affirmFlag=2";;
			  document.form1.submit();
	  }
  }
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		    ...
		    <c:forEach items="${tempCardAffirmList}" var="test" varStatus="i">	
		     ...
		     <input type="hidden" name="applyer_${i.index}" value="${test.APPLYER}">	
		    <tr align="center">
		...
		<input type="hidden" name="currentPage" value="${currentPage}">	
					...
					<ait:page       
		               ...
		               parameters="&operation=gaAffirm&content=temporarycardApplicationAffirm&menu_code=${param.menu_code}&startDate=${startDate}&endDate=${endDate}&qryType=${qryType}&deptid=${deptid}&key=${key}" 
		               total="${resultCount}"
