...
<SCRIPT type="text/javascript">
 ...
 function search(){
 document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=view&content=checkapplicationview";
 ...
 function doBatchConfirm(){ 
   ...
   if(!selectFlag){
		  ...
		  document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=view&content=oingCheckConfirm&Flag=1";
		  document.form1.submit();
  }
 ...
 function doBatchReject(){
   if(confirm("确认对已选择的信息进行否决吗？")){  
	   ...
	   if(!selectFlag){
			  ...
			  document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=view&content=oingCheckConfirm&Flag=2";;
			  document.form1.submit();
	  }
  }
}
 ...
 function ExportExcel() {
	document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=view&content=excelcheckapplicationview";
	document.form1.submit();
}
</SCRIPT>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		    ...
		    <c:forEach items="${CheckConfirmList}" var="test" varStatus="i">		
		    <tr align="center">
		      <input type="hidden" name="applyNo_${i.index}" value="${test.APPLY_NO}">
		      <input type="hidden" name="checkAccount_${i.index}" value="${test.CHECKACCOUNT}">
		      ...
		      <td nowrap="nowrap">        
		          ...
		          <c:if test="${test.ISCONFIRM==0}">
		          <span style="color:red; cursor:pointer;" onClick="singleAffirm(2,'${i.index}');">作废</span>
		          </c:if>
		      </td>		
		      </tr>	   
		      </table>
		   ...
		   <input type="hidden" name="currentPage" value="${currentPage}">	    
					...
					<ait:page       
		               ...
		               parameters="&operation=view&content=checkapplicationview&menu_code=${param.menu_code}&startDate=${startDate}&endDate=${endDate}&qryType=${qryType}&deptid=${deptid}&key=${key}" 
		               total="${resultCount}"
