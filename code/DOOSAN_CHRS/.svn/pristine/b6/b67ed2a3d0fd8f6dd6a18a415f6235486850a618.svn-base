...
public class CheckLoginForWorkerCmd extends AbstractCmd implements Command {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = apiService.login(request);
		if (result != null && !"".equals(result)) {
			response.getWriter().append(R.toJson(R.ok().put("username",result)));
		}else{
