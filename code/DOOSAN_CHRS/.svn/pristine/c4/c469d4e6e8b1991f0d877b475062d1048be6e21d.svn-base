...
<jsp:useBean id="payPlan03Serche" class="java.util.ArrayList" scope="request"></jsp:useBean>
<jsp:useBean id="FRateList" class="java.util.ArrayList" scope="request"></jsp:useBean>
<jsp:useBean id="BRateList" class="java.util.ArrayList" scope="request"></jsp:useBean>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table width="60%" border="0" cellpadding="0" cellspacing="1" class="dr_d" >
		...
		<td height="15"  align="center" class="info_title_01">
		 ...
		 &nbsp;&nbsp;
		  ...
		  <td height="15"  align="center" class="info_title_01" rowspan="2">		 
	...
	<table width="60%" border="0" cellpadding="0" cellspacing="1" class="dr_d">
	 <tr align="center" bgcolor="#F5F5F5">
		    ...
		    <tr>
		    <td nowrap="nowrap" align="center" class="info_title_01" >工厂比率</td>
		    <%for(int i=0;i<FRateList.size();i++){
		    dataMap=(SimpleMap)FRateList.get(i);%>
		    <td nowrap="nowrap" align="center" class="info_content_01" ><input name="FRate<%=i+1%>" type="text" value="<%=dataMap.get("FRate"+(i+1))%>" style="width:50px"></td>
		    <%}%>		   
		    </tr>
		    <tr>
		    <td nowrap="nowrap" align="center" class="info_title_01" >支社比率</td>
		    <%for(int i=0;i<BRateList.size();i++){
		     dataMap=(SimpleMap)BRateList.get(i);%>
		    <td nowrap="nowrap" align="center" class="info_content_01" ><input name="BRate<%=i+1%>" type="text" value="<%=dataMap.get("BRate"+(i+1))%>" style="width:50px"></td>
		    <%}%>
		    </tr>
    ...
    <br>
    	<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		   ...
		   <%for(int i=0;i<payPlan03Serche.size();i++){
		   dataMap=(SimpleMap)payPlan03Serche.get(i);%>
		   <tr>
		   <td nowrap="nowrap" class="info_content_00"><%=i+1%></td>	
			...
			<%for(int s=1;s<13;s++){ %>			
			 ...
			 <td nowrap="nowrap" class="info_content_00"><%=dataMap.get("rate"+s) %></td>
			 <td nowrap="nowrap" class="info_content_00"><%=dataMap.get("bonus"+s) %></td>
			<%} %>
		   </tr>
		   <%}%>	
		</table>
