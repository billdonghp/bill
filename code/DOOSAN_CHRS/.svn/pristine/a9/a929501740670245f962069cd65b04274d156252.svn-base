<%@ page contentType="text/html; charset=UTF-8" language="java" import="com.ait.ar.dao.AnnualBean,com.ait.hr.bean.*,com.ait.ess.entity.*,java.util.Date,java.text.*,com.ait.util.*" errorPage="" %>
...
<jsp:useBean id="annual" class="com.ait.ar.bean.Annual" />
<html>
<head>
...
function ChangeUnit() {
	if (document.LeaveForm.leaveApplyTypeCode.value == "AH2") {
		document.all.unit.innerText="天";
	} else {
		document.all.unit.innerText="小时";
	}
}
 //-->
</SCRIPT>
<%
	String result = request.getParameter("result");
	 ...
	 annual = annualBean.empAnnual(admin.getAdminID());
%>
...
<table width="90%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  <tr align="center">
    <td width="19%" height="30"  align="center" bgcolor="#F5F5F5">休假人选择</td>
    ...
    <td width="34%" height="30"  align="left"><select name="leaveApplyTypeCode" onChange="ChangeUnit();" style="width:85px ">
			...
			%>
          </select>&nbsp;&nbsp;剩余年假: <%=annual.getAnnualHoursLeft()/8%>天</td>
  </tr>
   <tr align="center">
    <td width="19%" height="30"  align="center" bgcolor="#F5F5F5">申请日期</td>
    <td width="28%" height="30"  align="left"><%=yearCurrentDate%></td>
    <td width="19%" height="30"  align="center" bgcolor="#F5F5F5">休假长度</td>
    <td width="34%" height="30"  align="left">共&nbsp;<input name="leaveHours" type="text" style="width:40px ">&nbsp;<span id="unit">小时</span></td>
  </tr>
   <tr align="center">
