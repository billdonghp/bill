...
function Add() {
	...
	document.form1.action="/ga/ga_food_product_add.jsp?menu_code=${param.menu_code}"
...
function Update() {
	...
	document.form1.action="/gaControlServlet?operation=retrieveDataForUpdateFoodProuct&menu_code=${param.menu_code}";
	document.form1.submit();
}
function Delete() {
	if(document.form1.seqNo.value=="") {
	...
	if(confirm('确定删除吗？')){
		document.form1.action="/gaControlServlet?operation=deleteFoodProduct&menu_code=${param.menu_code}";
		document.form1.submit();
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
					<td width="8%" class="info_title_01">食品你名称</td>
					<td width="8%" class="info_title_01">品牌</td>
					<td width="8%" class="info_title_01">规格</td>
					<td width="8%" class="info_title_01">单位</td>
					<td width="8%" class="info_title_01">单价</td>
					<td width="8%" class="info_title_01">购买公司</td>
			...
			<c:forEach items="${recordList}" var="oneResult" varStatus="i">
				<tr align="center"
					...
					<td align="center" style="color: #666666;" height="27">${oneResult.FOOD_NAME}&nbsp;</td>
					...
					<td align="center" style="color: #666666;">${oneResult.PRICE}&nbsp;元</td>
					<td align="center" style="color: #666666;">${oneResult.PURCHASE_CPNY}&nbsp;</td>
