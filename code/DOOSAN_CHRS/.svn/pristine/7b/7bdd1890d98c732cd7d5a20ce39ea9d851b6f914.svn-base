...
public class Evszyzgdjsave2valuateCmd  implements Command{

				private static final Logger logger = Logger
				.getLogger(Evszyzgdjsave2valuateCmd.class);
...
//					if("78000000".equals(admin.getCpnyId()) && affirmEmail !=""){	元
				   if(affirmEmail !=""){	
						    ...
						    content.append("<br>").append("工种:").append(evscodeid);
				   ...
				   evsCraft.addEvsGxjndj();
					...
					if(affirmEmail !="")
					{
						...
						content.append("<br>");
						content.append("系统决裁页面位置:技能评价 > 领导决裁 > 职业资格等级修改决裁");
						content.append("<br>");
						content.append("--------------------------------------------------------------------------");
						content.append("<br>");
