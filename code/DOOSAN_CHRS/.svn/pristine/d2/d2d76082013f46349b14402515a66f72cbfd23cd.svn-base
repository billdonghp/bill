/*
 * @(#)RetrieveDataForDeleteAppendInfoCmd.java 1.0 2007-1-2 下午03:50:01
 *
 ...
 * @Date 2007-1-2 下午03:50:01
 * @version 1.0
 * 
 */
public class RetrieveDataForDeleteAppendInfoCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		return "/hrm/hrm_delete_append.jsp";
	}
