...
function Search(){
//重新搜索时应重置当前页数
	document.ApplyForm.action = "/gmControlServlet?operation=waste&content=monthClearingSearch&menu_code=${param.menu_code}&flag=1";
	document.ApplyForm.submit();
}


function ImportExcel() {
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=monthClearingSearch&menu_code=${param.menu_code}&flag=2";
	document.ApplyForm.submit();	
} 
</script> 
<%Date d = new Date();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<ait:page       
             ...
             parameters="&operation=waste&content=monthClearingSearch&menu_code=${param.menu_code}&StartTime=${StartTime }&EndTime=${EndTime }&wasteType=${wasteType }"
             total="${voitureInt}"
