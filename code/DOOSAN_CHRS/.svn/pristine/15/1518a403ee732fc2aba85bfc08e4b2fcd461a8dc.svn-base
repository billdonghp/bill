...
function Save() {
	...
	document.form1.action="/gaControlServlet?operation=insertFestivalScheme&menu_code=${param.menu_code}";
...
function updateValue(cell,i) 
{
		var url = "/ajaxControlServlet" ;
     	var pars = "operation=getPresetnInfoForInsertFestivalScheme&condition=" + encodeURIComponent(cell);
		new Ajax.Request(
		...
		<table id="Tables" width="100%" border="1" cellspacing="0"
			...
			<tr>
				...
				<td nowrap="nowrap" class="info_content_00">
					<input type="text" name="schemeName" required>
				</td>
			</tr>
			<tr>
				<td width="15%" class="info_title_01">备注</td>
				<td class="info_content_00">
					<textarea name="schemeRemark" rows="2" cols="25"></textarea></td>
			</tr>
			<tr>
			...
			<tr>
				<td nowrap="nowrap" class="info_content_01">
					<ait:select dataListName="presentNameList" name="presentName0" all="all" onChange="updateValue(this.value,0);"/>
				</td>
