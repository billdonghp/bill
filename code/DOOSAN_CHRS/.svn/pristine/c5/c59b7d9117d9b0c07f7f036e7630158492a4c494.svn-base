		  ...
		  <tr align="center"> 
			...
			<td  nowrap  class="info_title_01"><!--进位-->
				...
				<c:forEach items="${bonusItemList}" var="vlist" varStatus="">
				  <tr align="center" onclick="band('#E7F0EF','black','${vlist.ITEM_NO}')" > 
					<td height="30" >${vlist.ITEM_NO}&nbsp;</td>
					<td align="center" style="color: #666666;">${vlist.ITEM_ID}&nbsp;</td>
					<td align="center" style="color: #666666;">${vlist.ITEM_NAME}&nbsp;</td>
					<td align="center" style="color: #666666;">${vlist.CPNYNAME}&nbsp;</td>
					<td align="left" style="color: #666666;">${vlist.DESCR}&nbsp;</td>
					<td align="center" style="color: #666666;">${vlist.DATATYPE_NAME}&nbsp;</td>
					<td align="center" style="color: #666666;">${vlist.CALCU_ORDER}&nbsp;</td>
					<td align="center" style="color: #666666;">${vlist.ITEM_TYPE_NAME}&nbsp;</td>
...
ID='';
function Add(){
	location.href="pa/pa_bonus_item_add.jsp?menu_code=${param.menu_code}&currentPage=${currentPage}&search="+encodeURIComponent(document.search.search.value);
}
function Update(){
	if (ID!=''){
	location.href="/paControlServlet?operation=pa_bonus_item_forUpdate&menu_code=${param.menu_code}&currentPage=${currentPage}&item_no="+ID + "&search="+encodeURIComponent(document.search.search.value);
	}
	else{
	//"请选择参数"
...
function Delete(){
	...
	//"删除后,相关信息也将被清空!\n\n      确定要删除吗?"
		...
		location.href="/paControlServlet?operation=pa_bonus_item_delete&menu_code=${param.menu_code}&currentPage=${currentPage}&item_no="+ID + "&search="+encodeURIComponent(document.search.search.value);
		}
	}
	else{
	//"请选择参数"
...
function Search(){
location.href='/paControlServlet?operation=pa_bonus_item&flag=list&currentPage=${currentPage}&menu_code=${param.menu_code}&search='+encodeURIComponent(document.search.search.value);
}
