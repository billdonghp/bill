 ...
 * 
 */
public class YtglPresentListCmd extends GaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List recordList = services.ytglPresentList(parameterObject, currentPage, pageSize);
			Object recordCount = services.ytglPresentListCnt(parameterObject);
		...
		return "/ga_view_present_ytgl.jsp?menu_code=" + parameterObject.getString("menu_code");
	}
