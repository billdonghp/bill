...
{	
    ...
    document.form1.action="/gaControlServlet?operation=updateSmock&menu_code=${param.menu_code}";
		...
		<table id="tableObj" width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td class="info_content_00">
					<ait:codeClass codeClass="smockInfo" name="smockName" selected="${result.SMOCKNAME_T}" all="all"/>
				</td>
			</tr>
			<tr>
				<td width="15%" class="info_title_01">单位</td>
				<td class="info_content_00">
					<ait:codeClass name="unit" codeClass="SmockUnit" selected="${result.UNIT1}" all="all"/>
				</td>
			</tr>
			<tr>
				<td width="15%" class="info_title_01">尺寸类型</td>
				<td class="info_content_00">
					<ait:codeClass name="sizeType" codeClass="SizeType" selected="${result.SIZE_TYPE}" all="all"/>
				</td>
			</tr>
			<tr>
