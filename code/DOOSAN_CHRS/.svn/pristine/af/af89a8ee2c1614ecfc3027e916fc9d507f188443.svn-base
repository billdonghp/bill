...
<body>
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=pluarlity.xls");
  ...
  <tr>
    ...
    <td><table width="100%" border="1"
       ...
       <td align="center" height="40">结束日期</td>
        <td align="center" height="40" colspan="3">兼职内容</td>
      </tr>
            ...
            <td align="center" height="40">${temp.CHINESENAME }</td>   
             ...
             <td align="center" height="40" colspan="3">${temp.CONTENT }</td>
            </tr>
             </c:forEach>
