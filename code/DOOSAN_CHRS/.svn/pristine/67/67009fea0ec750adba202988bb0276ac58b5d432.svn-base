...
function submitImp(){ 
	document.form1.action="/essControlServlet?menu_code=${param.menu_code}&operation=add&content=upLoadFile&fileName="+$('fileName').value;
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d" align="left">
	<tr>
		...
		<table id="operateTable" width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d" align="left">
			<tr>
				<td style="width: 500px" align="center"><font size="3" style="font-weight:900">上传文件</font>
				<!--a href='#' onclick="tableUtil.appendRow();"><img src='/images/btn/continueAdd.gif' alt='继续添加' align='absmiddle'></a-->
				</td>
			</tr>
			<tr>
				<td><input type="file" name="upLoadFile" value="" style="width:400px" title="上传">&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" class="dr_d" align="left">
			<tr>
				<td><input id="submitButton" type="button" value="上传文件"	onclick="submitImp()" /></td>
			</tr>
		</table>
		</td>
	</tr>
