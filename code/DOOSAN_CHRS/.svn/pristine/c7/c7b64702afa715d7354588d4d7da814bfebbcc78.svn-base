/*
 * @(#)RetrieveDataForUpdateTrainingCmd.java 1.0 2006-12-19 下午05:15:44
 *
 ...
 * 
 */
public class RetrieveDataForUpdateTrainingCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		return "/hrm/hrm_modify_training.jsp";
	}
