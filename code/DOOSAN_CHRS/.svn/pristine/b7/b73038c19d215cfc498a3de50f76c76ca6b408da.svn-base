...
function Add(){
	...
	document.form1.action="hrmControlServlet?menu_code=hr0108&operation=retrieveDataForInsertHealth&empID=<c:out value='${empID}'/>";
	document.form1.submit();
 }
 
function Update(){

	document.form1.action="hrmControlServlet?menu_code=hr0108&operation=retrieveDataForUpdateHealth&empID=<c:out value='${empID}'/>";
	document.form1.submit();
}

function Delete(){
	
	document.form1.action="hrmControlServlet?menu_code=hr0108&operation=retrieveDataForDeleteHealth&empID=<c:out value='${empID}'/>";
	document.form1.submit();
}
