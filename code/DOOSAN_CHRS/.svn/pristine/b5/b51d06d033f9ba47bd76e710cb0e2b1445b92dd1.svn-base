...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0">
			<tr height="20">
				<td class="title1"><!--奖励 -->
				<ait:message messageID="display.ess.staff_info.award_discipline.award" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td class="info_title_01" height="30" nowrap><!--奖励日期 -->
							<ait:message messageID="display.ess.staff_info.award_discipline.award.award_date" module="ess" />
						</td>
						<td class="info_title_01" nowrap><!--奖励类型 -->
							<ait:message messageID="display.ess.staff_info.award_discipline.award.award_type" module="ess"/>
						</td>
						...
						<td class="info_title_01" nowrap><!--功绩内容 -->
							<ait:message messageID="display.ess.staff_info.award_discipline.award.award_contents" module="ess"/>
						</td>
						<td class="info_title_01" nowrap><!--奖励金额 -->
							<ait:message messageID="display.ess.staff_info.award_discipline.award.award_sum" module="ess" />
						</td>
					</tr>
			...
			<tr height="20">
				<td class="title1"><!--惩戒 -->
					<ait:message messageID="display.ess.staff_info.award_discipline.discipline" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td>
