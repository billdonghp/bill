...
<%
	...
	if (parameterObject.getString("statTypeCode").equals("C_12067_1330306")){
		recordList = service.retrieve600Report0207List(parameterObject) ;	
	}
	else{
		recordList = service.retrieve600Report0211List(parameterObject) ;
	}
...
<input type="hidden" name="url" value="pa_bonus_maintain_data_60000000.jsp" />
