...
<input name="content" value="InfoApplyFamilyContentImp" type="hidden">
...
<table width="80%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <td width="28%" height="30"  align="left"><input type="text" name="borndate" class="content"  style="width:85px ">&nbsp;<img src="/images/calendar/calender.gif" align="absMiddle" border="0" height="18" width="18" onClick="showCalendar('save','borndate');" style="cursor:hand"></td>
