...
public class DeletePaBonusParamCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			services.deletePaBonusParam(parameterObject) ;
		...
		request.setAttribute("url","/paControlServlet?operation=pa_bonus_param&menu_code=" + parameterObject.getString("menu_code"));
