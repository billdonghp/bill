/*
 * @(#)TrainingOutside.java 1.0 2006-12-28 上午10:29:47
 *
 ...
 * @Date 2006-12-28 上午10:29:47
 * @version 1.0
 * 
 */
public class TrainingOutside {

	private Integer trainOutNo;
	...
	private String enCourseType;

	private String korCourseType;

	private String institutionName;// 培训机关
	...
	public Integer getTrainOutNo() {
		return trainOutNo;
	}

	public void setTrainOutNo(Integer trainOutNo) {
		this.trainOutNo = trainOutNo;
	}
	...
	public String getEnCourseType() {
		return enCourseType;
	}

	public void setEnCourseType(String enCourseType) {
		this.enCourseType = enCourseType;
	}

	public String getKorCourseType() {
		return korCourseType;
	}

	public void setKorCourseType(String korCourseType) {
		this.korCourseType = korCourseType;
	}
