  ...
  <tr  height="50">
    <td colspan="8">             
	    <table width="100%">
	        ...
	        <ait:message messageID="display.ess.attendance_request.absence.absence_request_report"  module="ess"></ait:message>
	    	 </td>
	    	</tr>
	      <tr>     
	    		 <td   height="30">&nbsp;</td>
  ...
  <tr> 
     <table width="100%" border="1"
        ...
        <!--  申请号--> </strong></div></td>
         ...
         <td   height="50" colspan="2" align="center"><div  height="50"><strong>
       ...
       <ait:message messageID="display.ess.review.time_off.type"  module="ess"></ait:message>      
        ...
        <tr>
           <td   height="50"><div align="center"><strong><!-- 休假时段  -->
              <ait:message messageID="display.ess.review.time_off.period"  module="ess"></ait:message>      
         </strong></div></td>
          <td colspan="8"  nowrap  align="center">${applyLeaveDetail.LEAVE_FROM_TIME} ~~ ${applyLeaveDetail.LEAVE_TO_TIME}</td>
        </tr>
		<tr>
          <td   height="50" align="center" rowspan="9"><div align="center"><strong><!-- 休假原因  -->
