...
function Save(type, status,cpnyId, statTypeCode) {
	...
	document.form1.action="/arControlServlet?operation=ar_modify&content=payStatus&menu_code=${menu_code}&status=" + status + "&STAT_TYPE_CODE=" + statTypeCode+"&cpnyId="+cpnyId;
	...
	<tr>
		...
		<table width="100%"  border="1"cellspacing="0" cellpadding="2" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
		    ...
		    <tr align="center"> 
			  ...
			  <td height="30" class="info_content_01"><a  href="javascript:Save('PA_LOCK_FLAG','${oneResult.PA_LOCK_FLAG}','${oneResult.CPNY_ID}','${oneResult.STAT_TYPE_CODE}')"><img src="/images/${oneResult.PA_LOCK_FLAG}.gif" border="0" width="20" height="25"></a></td>
