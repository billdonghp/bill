...
var xaMessagesTable = {
  "required"       : [ "必输项." ],
  "reg_exp"        : [ "不符合Regular Expression（正规式）。\n形式须符合@。" ],
  "mask"           : [ "是错误形式的输入。\n须以[@]形式输入。" ],
  "alphabetic"     : [ "不是alphabetic形式" ],
  "numeric"        : [ "不是numeric形式。" ],
  "alpha_numeric"  : [ "不是alphabetic 或 numeric 形式" ],
  "integer"        : [ "不是integer(整数) 形式。" ],
  "float"          : [ "不是实数形式。" ],
  "hexa"           : [ "不是16进制（Hexa）形式。" ],
  "maxlength"      : [ "所输入的项目的位数太大。\n最大@位数以下。" ],
  "minlength"      : [ "所输入的项目的位数太小。 \n最小@位数以上。" ],
  "maxbyte"        : [ "所输入的项目的位数太大。\n最大@位数以下。\n(中文一个字算作2位数" ],
  "minbyte"        : [ "所输入的项目的位数太小。\n最小@位数以上。\n(中文一个字算作2位数" ],
  "maxvalue"       : [ "所输入的项目的值太大。\n当前值为@。\n最大也应是@以下的值。" ],
  "minvalue"       : [ "所输入的项目的值太小。\n当前值为@。 \n最小也应是@以上的值。" ],
  "money"          : [ "不是适当的金额（韩币）形式。" ],
  "dollar"         : [ "不是适当的金额（美元）形式。" ],
  "date"           : [ "日期输入错误。" ],
  "credit_card"    : [ "不是Credit Card编号形式。" ],
  "email"          : [ "不是邮件形式。" ],
  "domain"         : [ "Domain形式有错误。" ],
  "psn"            : [ "输入的身份证号有错误。" ],
  "csn"            : [ "输入的营业执照号有错误。" ],
  ...
  "hpd"            : [ "@不是正确的手机/PCS 号。 "],
  "ddd"            : [ "@不是正确的DDD编号。" ],
  "is_value"       : [ "[@]项目的输入值与[@]项目的输入值不一样。", "xJos Says :\n[@]中的is_value 使用不正确。\n[@]相应的输入字段Object不存在或 \n相应输入字段是多个。" ],
  "filesize_limit" : [ "选择的文件的Size太大。须[@]以下。" ],
  "itemname"       : [ "发生输入错误 : 项目名 [@]\n\n" ],
  "disable_submit" : [ "防止双重申请 :\n稍候请再试一下。"]
};
  ...
  if (window.xGetOption("X_VALIDATE_DO_ERROR_ACTION")) {
    if (this.type == 'hidden' && window.xGetOption("X_SUPPORT_HIDDEN_TYPE") ) {
      if (this.getNextFocus && this.getNextFocus()) this.getNextFocus().focus();
        ...
        this.setBgColor("#EFF9FF", "xjs_error");
      }
  }
