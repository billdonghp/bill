...
{	
    ...
    document.form1.action="/gaControlServlet?operation=insertFestivalPresent&menu_code=${param.menu_code}";
		...
		<table id="tableObj" width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td class="info_content_00">
					<input type="text" name="presentName" size="10" required>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="info_content_00">
					<input type="text" name="specific" size="10" required>
				</td>
			</tr>
			<tr>
				<td width="15%" class="info_title_01">单位</td>
				<td class="info_content_00">
					<ait:codeClass codeClass="festivalPresentUnit" name="unit" all="all"/>
				</td>
			</tr>
			<tr>
				<td width="15%" class="info_title_01">单价</td>
				<td class="info_content_00">
					<input type="text" name="unitPrice" size="10" required>&nbsp;元
				</td>
			</tr>
			<tr>
