...
<html>
<head>
<!-- pa_maintain_data_filialess_60000000.jsp -->
<%
	...
	List recordList = service.retrieve600Report0206Listss(parameterObject);
...
<input type="hidden" name="url" value="pa_maintain_data_filialess_60000000.jsp" />
    ...
    <td nowrap>
    	<table>
    		...
    		<tr>
    			...
    			<td class="info_title_01">病休222</td>
