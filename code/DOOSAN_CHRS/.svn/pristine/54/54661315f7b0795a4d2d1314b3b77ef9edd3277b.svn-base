...
function ImportExcel() {
	     ...
	     window.open("/reports/gm_report/gm_DifferenceDetailseateryReport.jsp?startdate="+startdate+"&enddate="+enddate,"");
} 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td align="left" class="title1" colspan="10">就餐差异明细对比表</td>
			</tr>
		</table>
