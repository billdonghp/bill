...
<%
	...
	List recordList = service.retrieve780Report0206List(parameterObject);
...
<input type="hidden" name="supplyFlag" value="N" />
    ...
    <td nowrap>
    	<table>
    		...
    		<tr>
    			...
    			<td class="info_title_01">放假方案减除</td>
    		</tr>
    		<tr>
    			...
    			<td><input type="text" size="8" maxlength="10" name="HOLIDAY_PLAN"  value="${paData.HOLIDAY_PLAN}" required  float/></td>
    		</tr>
    		<tr>
