...
reportname = "78000000_pa_bonus_payslip_filiale.rpt"
%>
...
bonusTypeCode = Request.QueryString("bonusTypeCode")
bonusNO = Request.QueryString("bonusNO")
...
Session("oRpt").ParameterFields.GetItemByName("bonusTypeCode").AddCurrentValue(CStr(bonusTypeCode))

Session("oRpt").ParameterFields.GetItemByName("bonusNO").AddCurrentValue(CDbl(bonusNO))
