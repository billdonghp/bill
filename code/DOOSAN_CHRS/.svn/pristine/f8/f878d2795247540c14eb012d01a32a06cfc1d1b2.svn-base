/*
 * @(#)SearchPunishCmd.java 1.0 2007-1-5 下午01:59:19
 *
 ...
 * @Date 2007-1-5 下午01:59:19
 * @version 1.0
 * 
 */
public class SearchPunishCmd extends HrmAbstractCommand {
	...
	try {
	    ...
	    List list = services.getPunishMent(sMap, currentPage,pageSize);
	    resultCount = NumberUtil.parseInt(services.getPunishMentCnt(sMap).toString(), 0);
	...
	return "/hrm/hrm_dl_search_punishment.jsp";
    }
