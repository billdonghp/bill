...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <td  align="center"><%=qualification.getChineseName()%>&nbsp;</td>
    <td  align="center"><%=qualification.getEmpID()%>&nbsp;</td>
    ...
    <td  height="30"  align="center"><a href="/ess/ess0502_t.jsp?qualificationNo=<%=qualification.getQualificationNo()%>&flag=1&menu_code=<%=menu_code%>"><font color="#00CC00">通过</font></a><font color="#00CC00">&nbsp;/&nbsp;</font><a href="/ess/ess0502_t.jsp?qualificationNo=<%=qualification.getQualificationNo()%>&flag=2&menu_code=<%=menu_code%>"><font color="#00CC00">不通过</font></a></td>
	        <%}else if(qualification.getActivity()==1){%>
    <td  height="30"  align="center"><font color="#990099"><%=qualification.getUpdatedBy()%>&nbsp;已通过</font></td>
