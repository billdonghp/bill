/*
 * @(#)DelPluralityComCmd.java 1.0 2007-1-5 下午01:58:49
 *
 ...
 * @Date 2007-1-5 下午01:58:49
 * @version 1.0
 * 
 */
public class DelPluralityComCmd extends HrmAbstractCommand {
...
//	删除兼职信息
	...
	try {
	    ...
	    services.delPlurality(lPlurality);
	} catch (Exception e) {
	    Logger.getLogger(getClass()).error(e.toString());
	    msg="保存失败";
	    throw new GlRuntimeException("删除兼职信息失败！", e);
	}
	//提示
	request.setAttribute("alert", msg);
	//跳转的新页
	request.setAttribute("url", "/hrmControlServlet?operation=searchPlurality&menu_code="+request.getParameter("menu_code"));
