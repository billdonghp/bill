...
var MENU_CODE;
var CPNYID;
function HighLightTR(backColor, textColor, i, menu_code,cpnyid, m_code) {
    var t;
...
function Add() {
    ...
    /*
    if (ID == "") {
        url = "/sy/sy0101_a.jsp?menu_code=sy0101";                 
    } else {
        url = "/sy/" + MENU_CODE + "_a.jsp?menu_code=" + MENU_CODE + "&m_code=" + M_CODE;
    } */
    location.href = url;   
}
function Update(msg) {
    if (ID == "") {
        ...
        url = "/sy/" + MENU_CODE + "_m.jsp?no=" + ID + "&menu_code=" + MENU_CODE+"&cpnyid="+CPNYID;
        location.href = url;
    }
}
function Active() {
