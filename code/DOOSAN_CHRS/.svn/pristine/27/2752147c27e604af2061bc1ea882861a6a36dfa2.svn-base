		...
		<table width="100%" border="0" cellpadding="0">
			<tr>
				<td width="21%" class="title1"><!-- 资格证书 -->
							<ait:message  messageID="display.ess.staff_info.other_info.certificate" module="ess"/>	
						</td>
			</tr>
			<tr height="135">
				<td colspan="2">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td height="30" class="info_title_01" nowrap><!-- 资格证名称 -->
							<ait:message  messageID="display.ess.staff_info.other_info.certificate.certificate_title" module="ess"/>	
						</td>
						<td class="info_title_01" nowrap><!-- 证件号 -->
							<ait:message  messageID="display.ess.staff_info.other_info.certificate.certificate_no" module="ess"/>	
						</td>
						<td class="info_title_01" nowrap><!-- 证件级别 -->
							<ait:message  messageID="display.ess.staff_info.other_info.certificate.certificate_grade" module="ess"/>	
						</td>
						<td class="info_title_01" nowrap><!-- 发证处 -->
							<ait:message  messageID="display.ess.staff_info.other_info.certificate.certificate_authority" module="ess"/>	
						</td>
						<td class="info_title_01" nowrap><!-- 取证日期 -->
							<ait:message  messageID="display.ess.staff_info.other_info.date_of_obtaining" module="ess"/>	
						</td>
					</tr>
			...
			<tr>
				<td class="title1"><!-- 入社前经历 -->
							<ait:message  messageID="display.ess.staff_info.other_info.previous_experience" module="ess"/>	
						</td>
			</tr>
			<tr height="135">
				<td colspan="2">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td height="30" class="info_title_01" nowrap><!-- 工作单位 -->
							<ait:message  messageID="display.ess.staff_info.other_info.company" module="ess"/>	
						</td>
						...
						<td class="info_title_01" nowrap><!-- 工作业务内容 -->
							<ait:message  messageID="display.ess.staff_info.other_info.work_contents" module="ess"/>	
						</td>
					</tr>
