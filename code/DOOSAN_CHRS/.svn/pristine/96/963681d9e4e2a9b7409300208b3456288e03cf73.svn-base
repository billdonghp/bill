...
function Searchsubmit(){
 	document.form1.action="/gmControlServlet?operation=gm_vegetable&menu_code=${param.menu_code}";
 	document.form1.submit();
}

function ImportExcel(){
 	document.form1.action="/gmControlServlet?operation=gm_vegetable&menu_code=${param.menu_code}&flag=excel";
 	document.form1.submit();
}

function Add() {
	document.form1.action="/gmControlServlet?operation=gm_vegetable_add&menu_code=${param.menu_code}";
	document.form1.submit();
}
function Update() {
	...
	document.form1.action="/gmControlServlet?operation=gm_vegetable_update&menu_code=${param.menu_code}&VEGET_ID="+document.form1.temp.value;
	document.form1.submit();
}
function Delete() {
	if(document.form1.temp.value==0) {
	...
	if(confirm('确定删除吗？')){
		document.form1.action="/gmControlServlet?operation=gm_vegetable_delete&menu_code=${param.menu_code}&VEGET_ID=" + document.form1.temp.value;
		document.form1.submit();
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" >
			<tr>
				<td align="left" class="title1" colspan="10">菜品设置</td>
			</tr>
		</table>
		...
		<c:forEach items="${gmVegetableViewList}" var="oneResult" varStatus="i">
		    <tr onClick="band('#E7F0EF','black',${oneResult.VEGET_ID})" height="30">
			      ...
			      <td align="center" style="color: #666666;">${oneResult.LOGIN_DATE}&nbsp;</td>
			      <td align="center" style="color: #666666;">${oneResult.DEVELOP}&nbsp;</td>
		    ...
		    <tr align="center"> </tr>
		        ...
		        <ait:page       
		               ...
		               parameters="&operation=gm_vegetable&menu_code=${param.menu_code}" 
		               total="${recordCount}"
