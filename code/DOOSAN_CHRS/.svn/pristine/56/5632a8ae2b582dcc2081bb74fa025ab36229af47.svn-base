...
public class ExportReport0538Cmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			parameterObject.setString("purposeid", purposeid);
...
//			 columns.setString("熟练度", "PROFICIENCY"); 
//			 columns.setString("设备保全", "SHEOPERCYQ"); 
//			 columns.setString("作业基准书遵守", "OPERATIONCOM"); 
//			 columns.setString("作业品质", "QUALITYOFWORK"); 
//			 columns.setString("标准动作", "STANDARDACTION"); 
			 columns.setString("综合得分", "COMPOSITE"); 
			 columns.setString("主要问题点", "REMARK"); 
