...
public class EvSearchEmployeeAllCmd implements Command {
	...
	public String execute(HttpServletRequest request,
		...
		List empList = services.retrievePaEmpList(parameterObject);	    	
        ...
        if (empList.size() > 0) {           
            ...
            while(iter.hasNext()) {
            	...
            	str.append("<tr  onClick='updateValue(this,"+no+");'>") ;
            	//工号
