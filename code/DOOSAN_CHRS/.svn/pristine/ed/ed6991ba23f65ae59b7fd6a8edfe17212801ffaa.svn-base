 ...
 * 
 */
public class DeleteAttRecordCmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			services.deleteAttRecord(parameterObject, true);
			...
			request.setAttribute("DOOR_TYPE", paramters.getString("DOOR_TYPE"));
			request.setAttribute("INSERT_BY", paramters.getString("INSERT_BY"));

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("delete attendance record by batch Exception. ", e);
		}

//		return "arControlServlet?operation=retrieveAttRecordList&menu_code=" + request.getParameter("menu_code")
//				+"&R_TIME=" + paramters.getString("R_TIME") +"&DEPTID=" + paramters.getString("DEPTID")
//				+ "&key=" + paramters.getString("key") + "&DOOR_TYPE" + paramters.getString("DOOR_TYPE")
...
//		删除成功
		...
		request.setAttribute("url","arControlServlet?operation=retrieveAttRecordList&menu_code=" + request.getParameter("menu_code")
				+"&R_TIME=" + paramters.getString("R_TIME") +"&DEPTID=" + paramters.getString("DEPTID")
				+ "&key=" + paramters.getString("key") + "&DOOR_TYPE" + paramters.getString("DOOR_TYPE")
				+ "&INSERT_BY=" + paramters.getString("INSERT_BY"));
