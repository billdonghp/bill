...
public class ViewEssLeaveParamCmd extends SysAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  
		...
		try {
			...
			int resultCount = syservice.getEssLeaveParamListCnt(parameterObject);
			...
			List essLeaveParmList = syservice.getEssLeaveParamList(parameterObject, currentPage, pageSize);
			
			
			request.setAttribute("essLeaveParmList", essLeaveParmList) ;
			request.setAttribute("APPLY_TYPE", parameterObject.get("APPLY_TYPE")) ;
		...
		return "sy/sy_view_essleave.jsp" ;	  
	}
