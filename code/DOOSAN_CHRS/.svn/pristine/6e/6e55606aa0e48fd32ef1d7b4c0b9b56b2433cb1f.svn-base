		...
		<table width="100%" border="0" cellpadding="0">
			<tr height="20">
				<td class="title1"><!-- 社内经历 -->
					<ait:message  messageID="display.emp.staff_info.promotion.experience_in_company" module="hrm"/>	
				</td>
			</tr>
			<tr height="132">
				<td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td class="info_title_01" height="30" nowrap><!-- 实施日期 -->
							<ait:message  messageID="display.emp.staff_info.promotion.implement_date" module="hrm"/>	
						</td>
