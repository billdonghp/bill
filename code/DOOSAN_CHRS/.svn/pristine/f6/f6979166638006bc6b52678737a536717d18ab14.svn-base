...
<SCRIPT type="text/javascript">
 ...
 function search(){
 document.form1.action="/gaControlServlet?menu_code=ga0215&operation=gaAffirm&content=checkApplicationAffirm";
 ...
 function doAffirm(){ 
   ...
   if(!selectFlag){
          ...
          document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=gaAffirm&content=batchCheckAffirm&affirmFlag=1";
		  document.form1.submit();
   }
 ...
 function doReject(){
   if(confirm("确认对已选择的信息进行否决吗？")){  
	   ...
	   if(!selectFlag){
			  ...
			  document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=gaAffirm&content=batchCheckAffirm&affirmFlag=2";;
			  document.form1.submit();
	  }
  }
}
	...
	<tr>
		...
		<input type="hidden" name="currentPage" value="${currentPage}">	
					...
					<ait:page       
		               ...
		               parameters="&operation=gaAffirm&content=checkApplicationAffirm&menu_code=${param.menu_code}&startDate=${startDate}&endDate=${endDate}&qryType=${qryType}&deptid=${deptid}&key=${key}" 
		               total="${resultCount}"
