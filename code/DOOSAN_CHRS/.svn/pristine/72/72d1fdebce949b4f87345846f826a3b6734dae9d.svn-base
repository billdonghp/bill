...
<body>
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=arDeailBackReport.xls");
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="center" height="60">
    <td colspan="2">             
	    <table width="100%">
	    	<tr>
	    		<td align="center" colspan="14"><b><font size="+2"><!-- 考勤明细维护修改报表 -->考勤明细维护修改报表</font></b></td>
	    	</tr>
	    </table>    	
    </td>
  </tr>
  ...
  <tr>
    <td><table width="100%" border="2"   
		...
		<tr>
         ...
         <td align="center"><!--创建者--><ait:message  messageID="display.mutual.created_by"/></td>
		 <td align="center"><!--创建时间--><ait:message  messageID="report.global.title.creation_date" module="report"/></td>
      ...
      for(int i=0;i<datalist.size();i++)
      {
    	 ...
    	 <tr>
    	  ...
    	  <td align="center"><%=detail.getCreateBy() %></td>
    	  <td align="center"><%=detail.getCreateDate() %></td>                 
