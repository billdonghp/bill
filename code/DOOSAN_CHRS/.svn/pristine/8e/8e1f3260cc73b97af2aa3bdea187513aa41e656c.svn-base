    ...
    <%
     ...
     <table	border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
     	...
     	<tr>
     		...
     		<td align="center" rowspan=1 colspan=12>中方人员</td>
     		<td align="center" rowspan=2 colspan=2></td>
     		</tr>
     		<tr>
     		<td align="center" rowspan=1 colspan=5>管理支持序列</td>
     		<td align="center" rowspan=1 colspan=4>生产序列</td>
     		...
     		<td align="center">职责部长/总监</td>
     		<td align="center">非职责部长</td>
     		...
     		<td align="center">职责主任</td>
     		<td align="center">非职责主任</td>
   		...
   		<%  List prList = rd.getPostInfoByDeptIdSpecialCN("0001.01.05"); %>
   		<%  List prListKR = rd.getPostInfoByDeptIdSpecialKR("0001.01.05"); %>
   		<tr>
   			...
   			<%} %>
   			<td align="center"><%=pr.getBuzhang2() %></td>
   			...
   			<td align="center"><%=prCN.getManager()+prCN.getManager2() %></td>
   			...
   			<td align="center"><%=prCN.getZhuren2() %></td>
	   		...
	   		if(flag){ 
				...
				prTotal.setBuzhang2(pr.getBuzhang2());
				...
				prTotal.setManager2(prCN.getManager2()) ;
				...
				prTotal.setZhuren2(prCN.getZhuren2()) ;
   		...
   		<%  prList = rd.getPostInfoByDeptIdSpecialCN("0001.01.02"); %>
   		<%  prListKR = rd.getPostInfoByDeptIdSpecialKR("0001.01.02"); %>
   		<tr>
	   		...
	   		if(flag){ 
				...
				prTotal.setBuzhang2(prTotal.getBuzhang2()+pr.getBuzhang2());
				...
				prTotal.setManager2(prTotal.getManager2()+prCN.getManager2()) ;
				...
				prTotal.setZhuren2(prTotal.getZhuren2()+prCN.getZhuren2()) ;
   		...
   		<%  prList = rd.getPostInfoByDeptIdSpecialCN("0001.01.03"); %>
   		<%  prListKR = rd.getPostInfoByDeptIdSpecialKR("0001.01.03"); %>
   		<tr>
     	...
     	<% prList = rd.getPostInfoByDeptIdSpecialCN("0001.01.01"); %>
     	<% prListKR = rd.getPostInfoByDeptIdSpecialKR("0001.01.01"); %>
   		<tr>
     	...
     	<tr>
   			...
   			<td align="center"><%=prTotal.getBuZhang()+1 %></td>
   			<td align="center"><%=prTotal.getBuzhang2() %></td>
   			...
   			<td align="center">1</td>
   			<td align="center"><%=prTotal.getManager()+prTotal.getManager2() %></td>
   			...
   			<td align="center"><%=prTotal.getZhuren2() %></td>
