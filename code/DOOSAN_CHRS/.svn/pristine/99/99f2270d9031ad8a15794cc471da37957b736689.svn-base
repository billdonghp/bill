/*
 * @(#)DeletePresentApplyCmd.java 1.0 2009-7-16 下午03:06:28
 *
 ...
 * @Date 2009-7-16 下午03:06:28
 * @version 1.0
 * 
 */
public class DeletePresentApplyCmd extends GaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// delete present apply
			services.updatePresentApply(parameterObject);

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("Delete present apply Exception. ", e);
		}

		// 删除成功
		messageSource = new MessageSource(admin.getLocale(), "UTF-8");
		request.setAttribute("alert", messageSource.getMessage("alert.mutual.delete_successfully"));
		request.setAttribute("url","gaControlServlet?operation=retrievePresentApplyInfo&menu_code=" + parameterObject.getString("menu_code")
