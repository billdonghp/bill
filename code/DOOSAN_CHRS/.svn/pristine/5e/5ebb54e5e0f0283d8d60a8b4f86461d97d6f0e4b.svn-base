/*
 * @(#)GaAbstractCommand.java 1.0 2009-7-13 下午07:17:50
 *
 ...
 * @Date 2015-4-10 下午14:37:50
 * @version 1.0
 * 
 */
public abstract class GaAbstractCommand implements Command {
...
//	 child class implements the abstract methode
	...
	public void putToolbarInfo(HttpServletRequest request) throws GlRuntimeException {
		...
		try {
			...
			throw new GlRuntimeException("GaAbstractCommand put toolbar information to request Exception.", e);
		}
	}
}
