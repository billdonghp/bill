...
public class ExportFoodApplyCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			throw new GlRuntimeException(
					"Export food apply list cmd Exception. ",e);
		}
		
		this.putToolbarInfo(request);
		
		return "/ga_food_apply_export.jsp?menu_code="+ parameterObject.getString("menu_code");
	}
}
