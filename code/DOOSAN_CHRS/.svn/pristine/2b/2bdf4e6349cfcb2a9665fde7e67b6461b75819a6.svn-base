...
<table width="98%" border="0"  height="50" cellpadding="0" cellspacing="0">
  ...
  <tr  height="50">
    <td colspan="8">             
	    <table width="100%">
	        ...
	        <ait:message messageID="display.ess.attendance_request.bulk_time_off.bulk_time_off_request_report"  module="ess"></ait:message>
	    	 </td>
	    	</tr>
	      <tr>     
	    		 <td   height="30">&nbsp;</td>
  ...
  <tr> 
     <table width="100%" border="1"
        ...
        <!--  申请号--> </strong></div></td>
          <td   colspan="2" align="center"><c:out value='${applyLeaveDetail.APPLY_GROUP_NO}'/></td>
          
           <td   height="50" colspan="2" align="center"><strong><!-- 休假时段  -->
              <ait:message messageID="display.ess.review.time_off.period"  module="ess"></ait:message>      
         </strong></td>
           <td   colspan="4" align="center"> ${applyLeaveDetail.LEAVE_FROM_TIME} ~~ ${applyLeaveDetail.LEAVE_TO_TIME}</td>  
        </tr>  
         <tr>
         <td   height="50" align="center" > <div  height="50"><div align="center" ><strong><!-- 申请时间  -->
        ...
        <td   height="50" align="center" colspan="2"><div align="center"><strong><!--  休假类型 -->
       <ait:message messageID="display.ess.review.time_off.type"  module="ess"></ait:message>      
         </strong></div></td>
        ...
        <tr>
         <td height="50"><div align="center"><strong><!-- 部门 -->
        ...
        <tr>
         <td   height="50"><div align="center"><div align="center"><strong><!-- 休假原因  -->
        <ait:message messageID="display.ess.review.time_off.reason"  module="ess"></ait:message>         
         </strong></div></td>
         <td colspan="8"  nowrap  align="center">${applyLeaveDetail.LEAVE_REASON}</td>
        </tr>
           <tr>
           <!-- 姓名  -->  
          <%
         String name[]=((SimpleMap)request.getAttribute("applyLeaveDetail")).get("APPLYER").toString().split(",");
         String enname[]=((SimpleMap)request.getAttribute("applyLeaveDetail")).get("ENAPPLYER").toString().split(",");
         int rowspan=name.length/8;
         %> 
