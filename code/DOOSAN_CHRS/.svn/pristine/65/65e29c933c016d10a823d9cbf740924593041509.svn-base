...
function Add(){   
	document.form1.action = "hrmControlServlet?menu_code=hr0101&operation=retrieveDataForInsertBaseInfo&empID=<c:out value='${empID}'/>"
	document.form1.submit();
}

function Update(){
	document.form1.action = "hrmControlServlet?menu_code=hr0101&operation=retrieveDataForUpdateBaseInfo&empID=<c:out value='${empID}'/>"
	document.form1.submit();
}

function Delete(){
	document.form1.action = "hrmControlServlet?menu_code=hr0101&operation=retrieveDataForDeleteBaseInfo&empID=<c:out value='${empID}'/>"
	document.form1.submit();
}
