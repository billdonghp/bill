...
public class RetrieveFestivalPresentAffirmCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			parameterObject.setString("affirmId", admin.getPersonId());
			...
			request.setAttribute("affirmType", request.getParameter("affirmType"));
		...
		return "/ga_affirm_festival_present.jsp?menu_code="+ parameterObject.getString("menu_code");
	}
}
