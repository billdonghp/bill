...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <%
		...
		response.setHeader("Content-Disposition", "attachment; filename=t_pa_bonus_result.xls");
		...
		parameterObject.set("bonusTypeCode", request.getParameter("bonusTypeCode")) ;
		parameterObject.set("bonusNo", request.getParameter("bonusNo")) ;
...
%>
	...
	<body>
		...
		<tr align="center" > 
<%
		List columnList = services.retrieveTPaBonusResultColumnList(parameterObject);
...
<%
		...
		List resultList = services.retrieveTPaBonusResultDataList(parameterObject) ;
