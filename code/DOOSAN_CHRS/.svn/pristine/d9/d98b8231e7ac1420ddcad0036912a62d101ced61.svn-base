...
public class InsertCertificateUpdateCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// insert present
			services.insertCertificateNovationForUpdate(parameterObject);
			
		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("Insert certificate novation for update Exception. ", e);
		}
