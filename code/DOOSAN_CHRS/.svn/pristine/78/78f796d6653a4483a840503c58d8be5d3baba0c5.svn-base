...
<SCRIPT type="text/javascript">
 function search(){
 document.form1.action="/gaControlServlet?menu_code=ga0316&operation=gaAffirm&content=viewtemporaryCardAffirmInfo";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		    ...
		    <c:forEach items="${tempCardAffirmInfoList}" var="test" varStatus="i">		
		    <tr align="center">
		      ...
		      <td nowrap="nowrap"  align="center" class="info_content_01">${test.CARD_NUMBER}&nbsp;</td>
		      <td nowrap="nowrap"  align="center" class="info_content_01">${test.RETURN_YN}&nbsp;</td>
		      <td nowrap="nowrap"  align="center" class="info_content_01">${test.RETURN_DATE}&nbsp;</td>
		      ...
		      <c:if test="${test.FIRSTAFFIRMFLAG==0 && test.APPLYERID eq adminid}"><a href="/gaControlServlet?menu_code=${param.menu_code}&operation=gaAffirm&content=deleteTempCardApply&applyNo=${test.APPLY_NO}" onclick="return(confirm('确认删除吗？这将清空所有的相关信息！'))"><font color="red">删除</font></a></c:if>&nbsp;		  
		      </td>
		      </tr>
		   ...
		   <input type="hidden" name="currentPage" value="${currentPage}">	    
					...
					<ait:page       
		               ...
		               parameters="&operation=gaAffirm&content=viewtemporaryCardAffirmInfo&menu_code=${param.menu_code}&startDate=${startDate}&endDate=${endDate}&qryType=${qryType}&deptid=${deptid}&key=${key}" 
		               total="${resultCount}"
