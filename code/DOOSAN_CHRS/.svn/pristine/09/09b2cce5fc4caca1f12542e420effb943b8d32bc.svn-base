/*
 * @(#)UpdateClothingCmd.java 1.0 2009-7-23 上午09:02:12
 *
 ...
 * @Date 2009-7-23 上午09:02:12
 * @version 1.0
 * 
 */
public class UpdateClothingCmd extends GaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			throw new GlRuntimeException("Update clothing Exception. ", e);
		}
