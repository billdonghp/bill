...
public class InsertPaBonusItemCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			services.insertPaBonusItem(parameterObject) ;
		...
		request.setAttribute("url","/kpaControlServlet?operation=pa_bonus_item&menu_code=" + parameterObject.getString("menu_code") + "&currentPage=" + parameterObject.getString("currentPage") + "&search=" + parameterObject.getString("search") );
