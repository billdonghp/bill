...
function Add() {
	...
	document.form1.action="/ga/ga_add_festival_present.jsp?menu_code=${param.menu_code}";
...
function Update() {
	...
	document.form1.action="/gaControlServlet?operation=retrieveDataForUpdateFestivalPresent&menu_code=${param.menu_code}";
	document.form1.submit();
}
function Delete() {
	if(document.form1.seqNo.value=="") {
	...
	if(confirm('确定删除吗？')){
		document.form1.action="/gaControlServlet?operation=deleteFestivalPresent&menu_code=${param.menu_code}";
		document.form1.submit();
	}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
					<td width="8%" class="info_title_01">礼品名称</td>
			...
			<c:forEach items="${recordList}" var="oneResult" varStatus="i">
				<tr align="center"
					...
					<td align="center" style="color: #666666;" height="27">${oneResult.PRESENT_NAME}&nbsp;</td>
