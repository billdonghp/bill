...
public class getCraftLine2Cmd implements Command {
	...
	public String execute(HttpServletRequest request,
		...
		System.out.println(inepositionObjName + "11111111111");
		System.out.println(number+ "11111111111");
		...
		htmlPosition.append("<option value='请选择'>请选择</option></select>");
			...
			htmlPosition.append("<select name='"+inepositionObjName+"' onChange='fillLineAircraft2(this.value,"+number+");'>");
