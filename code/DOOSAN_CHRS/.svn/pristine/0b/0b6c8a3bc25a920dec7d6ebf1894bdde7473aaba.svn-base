/*
 * @(#)RetrieveDataForUpdateHealthCmd.java 1.0 2006-12-19 下午04:54:30
 *
 ...
 * 
 */
public class RetrieveDataForUpdateHealthCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		request.setAttribute("size", healthInfoList.size());
		request.setAttribute("healthInfoCnt", healthInfoList.size());
		request.setAttribute("empID", empID);
		request.setAttribute("adminId", adminId);
		
		return "/hrm/hrm_modify_health.jsp";
	}
