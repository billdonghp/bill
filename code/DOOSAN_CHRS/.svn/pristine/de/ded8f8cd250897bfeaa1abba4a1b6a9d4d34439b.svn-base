...
function submitImp(){ 
	document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=voitureManger&content=uploadVisiterDocuments&documentno="+encodeURIComponent(document.form1.documentno.value);
