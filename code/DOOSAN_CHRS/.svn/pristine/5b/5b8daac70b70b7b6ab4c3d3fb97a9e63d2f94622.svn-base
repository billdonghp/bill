...
function showMemo(val) {
 ...
 function search(){
 	document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=visaManger&content=visaManagementView";
    document.form1.submit(); 
 }  
 function ExportExcel() {
		document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=visaManger&content=excelSealInfoALL";
		document.form1.submit();
	}
...
function Update2(){
	  var selectFlag=false;
	   ...
	   if(!selectFlag){
		   ...
		   document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=visaManger&content=updateVisaWancheng";
		   document.form1.submit();
		   }
}
//
function Update3(){
	  var selectFlag=false;
	   ...
	   if(!selectFlag){
		   ...
		   document.form1.action="/gaControlServlet?menu_code=${param.menu_code}&operation=visaManger&content=updateVisaJuQian";
		   document.form1.submit();
		   }
}
function checkAll()
		...
		<ait:message messageID="display.mutual.search_criteria" module="ess"></ait:message>		
		  ...
		  <ait:message messageID="display.mutual.end_date" module="ess"></ait:message> 
		        ...
		        <td class="info_title_01">&nbsp;签证情况</td>
				 ...
				 <td class="info_content_00">							
						<ait:image src="/images/btn/Bulk_Over_R.gif"  border="0" align="absmiddle" 
          				onclick="javascript:Update2();" style="cursor:hand" title="完成" enTitle="update" />				
						</td>	
				<td class="info_content_00">							
						<ait:image src="/images/btn/Bulk_Reject_R.gif"  border="0" align="absmiddle" 
          				onclick="javascript:Update3();" style="cursor:hand" title="拒签" enTitle="update" />				
						</td>	
		        </tr>
		        </table>
		      </td>
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
		    <tr align="center" bgcolor="#F5F5F5">
		     <td nowrap="nowrap" class="info_title_01"><a href="#"
			  ...
			  <td nowrap="nowrap" class="info_title_01">
			   ...
			   <td nowrap="nowrap" class="info_title_01">完成日期</td>
			    <td nowrap="nowrap" class="info_title_01">
				提前日数</td>	
		      <td nowrap="nowrap" class="info_title_01">
				出差国家</td>
			...
			<td nowrap="nowrap" align="center" class="info_content_01">
		      ...
		      <td nowrap="nowrap" align="center" class="info_content_01" >${all.ISCOMPLISE }     </td>	
		         <td nowrap="nowrap" align="center" class="info_content_01" >${all.MANYZH } </td>	
		         <td nowrap="nowrap" align="center" class="info_content_01" > ${all.MANYFW }       </td>
		       <td nowrap="nowrap" align="center" class="info_content_01" >${all.MANYNQ }</td>
		 		...
		 		<input type="hidden" name="currentPage" value="${currentPage}">
					...
					<ait:page       
		               ...
		               parameters="&operation=visaManger&content=visaManagementView&menu_code=${param.menu_code}&qryType=${qryType}&key=${key}&startDate=${startDate}&endDate=${endDate}&cpnyId=${cpnyId}&codeName=${codeName}"
		               total="${resultCount}"
