/*
 * @(#)ViewExpiredProbationCmd.java 1.0 2007-9-17 下午03:49:39
 *
...
public class ViewExpiredProbationCmd extends HrmAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
		   ...
		   List listdata=services.getExpiredProbationByCondition(map,currentPage,pageSize);
		   resultCount = NumberUtil.parseInt(services.getExpiredProbationCNT(map).toString(), 0);       
		...
		return "/hrm/viewexpiredprobation.jsp";
