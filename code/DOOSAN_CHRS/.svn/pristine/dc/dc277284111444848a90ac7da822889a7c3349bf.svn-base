...
<%
	...
	List recordList = service.retrieve630Report0206List(parameterObject);
...
<input type="hidden" name="url" value="pa_maintain_data_factory_78000000.jsp" />
...
<input type="hidden" name="paMonth" value="${paData.PA_MONTH}" />
  ...
  <tr align="center" >
    <td nowrap>
    	<table>
    		<tr>
    			<td colspan="8" align="center" class="info_title_01"><font size="5">收入</font></td>
    		</tr>	
    		<tr>
    			...
    			<td class="info_title_01">研发补助</td>
    		</tr>
    		<tr>
    			...
    			<td><input type="text" size="8" maxlength="10" name="RESEARCH_SUBSIDIES"  value="${paData.RESEARCH_SUBSIDIES}" required  float/></td>
    		</tr>
    		<tr>
    			<td class="info_title_01">值班补助</td>
    			<td class="info_title_01">支给错误</td>
    			<td class="info_title_01">其他支给</td>
    			<td class="info_title_01">高温补助</td>
    			<td class="info_title_01">独生子女</td>
    		...
    		<tr>
    			...
    			<td><input type="text" size="8" maxlength="10" name="PAYMENT_HT_ALLOWANCE"  value="${paData.PAYMENT_HT_ALLOWANCE}" required  float/></td>
    			<td><input type="text" size="8" maxlength="10" name="ONLY_CHILD"  value="${paData.ONLY_CHILD}" required  float/></td>
