...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0">
			<tr>
				<td class="title1"><!-- 休职 -->
					<ait:message  messageID="display.ess.staff_info.unpaid_leave" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td width="31%" nowrap class="info_title_01"><!-- 休职事由 -->
							<ait:message  messageID="display.ess.staff_info.unpaid_leave.reason_of_unpaid_leave" module="ess"/>
						</td>
			...
			<tr>
				<td class="title1"><!-- 派遣 -->
							<ait:message  messageID="display.ess.staff_info.assignment" module="ess"/>
						</td>
			</tr>
			<tr height="135">
				<td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td width="31%" nowrap class="info_title_01"><!-- 派遣内容 -->
							<ait:message  messageID="display.ess.staff_info.assignment.assignment_contents" module="ess"/>
						</td>
						<td width="28%" nowrap class="info_title_01"><!-- 人事令号 -->
						<ait:message  messageID="display.mutual.regulation_no"/></td>
					</tr>
			...
			<tr>
				<td class="title1"><!-- 兼职 -->
							<ait:message  messageID="display.ess.staff_info.concurrent_job" module="ess"/>
						</td>
			</tr>
			<tr height="135">
				<td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td width="18%" height="30" nowrap class="info_title_01"><!-- 期间 -->
						<ait:message  messageID="display.mutual.period"/></td>
						<!-- <td width="23%" nowrap class="info_title_01">兼职事由</td> -->
						<td width="31%" nowrap class="info_title_01"><!-- 兼职内容 -->
							<ait:message  messageID="display.ess.staff_info.contents_of_concurrent_job" module="ess"/>
						</td>
						<td width="28%" nowrap class="info_title_01"><!-- 人事令号 -->
						<ait:message  messageID="display.mutual.regulation_no"/></td>
					</tr>          
