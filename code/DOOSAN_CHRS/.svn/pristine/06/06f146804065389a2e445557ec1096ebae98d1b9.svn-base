...
public class ExportReport0537001Cmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String  typeoationid = request.getParameter("typeoationid");
		...
		try {
			...
			parameterObject.setString("typeoationid", typeoationid);
		...
		return "/evsea/evs_SearchReport0537.jsp";
	}
	
	private List setInfo78000000() {
		
		return service.retrieve780Report0537List(parameterObject);
	}
}
