...
public class InsertPaBonusFormularCmd extends PaAbstractCommand {
...
System.out.println(name+"sssssssssssssssssssssssssssssssssssss");
			...
			services.insertPaBonusFormular(parameterObject) ;
		...
		request.setAttribute("url","/kpaControlServlet?operation=pa_bonus_formular_data&menu_code=" + parameterObject.getString("menu_code") + "&pa_item_no=" + parameterObject.getString("pa_item_no") );
