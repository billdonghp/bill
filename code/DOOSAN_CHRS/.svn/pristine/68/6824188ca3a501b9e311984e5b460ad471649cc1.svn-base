...
public class ExportReport0234Cmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            String pamonthstr = "斗山(中国)投资有限公司(烟台) "+paMonth.substring(0,4)+"年"+paMonth.substring(4,6)+"月工资明细表";
			// retrieve attendance record list
			List recordList = service.retrieveReport0234List(parameterObject);
			List recordListsum = service.retrieveReport0234ListSum(parameterObject);
