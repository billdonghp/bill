/*
 * @(#)RetrieveDataForUpdateRelationCmd.java 1.0 2006-12-19 下午05:04:22
 *
 ...
 * 
 */
public class RetrieveDataForUpdateRelationCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		return "/hrm/hrm_modify_relation.jsp";
	}
