		...
		<table width="100%" border="0" cellpadding="0">
			<tr>
				<td class="title1"><!-- 社内教育 -->
					<ait:message  messageID="display.ess.staff_info.training.internal_education" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td colspan="2">
			...
			<tr>
				<td class="title1"><!-- 社外培训 -->
					<ait:message  messageID="display.ess.staff_info.training.external_training" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td colspan="2">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td class="info_title_01" nowrap><!-- 培训机关 -->
							<ait:message  messageID="display.ess.staff_info.training.external_training.training_org" module="ess"/>
						</td>
						<td class="info_title_01" nowrap><!-- 分数 -->
							<ait:message  messageID="display.mutual.mark"/>
						</td>
			...
			<tr>
				<td class="title1"><!-- 研修 -->
					<ait:message  messageID="display.ess.staff_info.training.work_training" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td colspan="2">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td height="30" class="info_title_01" nowrap><!-- 研修类型 -->
							<ait:message  messageID="display.ess.staff_info.training.work_training.training_type" module="ess"/>
						</td>
						...
						<td class="info_title_01" nowrap><!-- 研修机关 -->
							<ait:message  messageID="display.ess.staff_info.training.work_training.training_org" module="ess"/>
						</td>
						<td class="info_title_01" nowrap><!-- 研修内容 -->
							<ait:message  messageID="display.ess.staff_info.training.work_training.narrative" module="ess"/>
						</td>
			...
			<tr>
				<td class="title1"><!-- 留学 -->
					<ait:message  messageID="display.ess.staff_info.training.study_abroad" module="ess"/>
				</td>
			</tr>
			<tr height="135">
				<td colspan="2">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr
						...
						<td width="12%" class="info_title_01" nowrap><!-- 留学机关 -->
							<ait:message  messageID="display.ess.staff_info.training.study_abroad.study_org" module="ess"/>
						</td>
