/*
 * @(#)InsertEateryRecordCmd.java 1.0 2007-9-27 上午09:24:03
 *
 ...
 * 
 */
public class InsertEateryRecordCmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// insert eatery record  
			services.insertEateryRecord(parameterObject);

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("insert eatery record Exception. ", e);
		}
		//添加成功
