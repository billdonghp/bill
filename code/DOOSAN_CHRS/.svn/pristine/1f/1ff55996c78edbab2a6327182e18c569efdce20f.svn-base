...
var L_BadDate       = "Este par\u00e1metro es de tipo\"Fecha\" y debe tener el formato \"aaaa-mm-dd\", siendo \"aaaa\" el a\u00f1o con cuatro d\u00edgitos, \"mm\" el mes (por ejemplo, enero = 1) y \"dd\" el d\u00eda del mes indicado.";
var L_BadDateTime   = "Este par\u00e1metro es de tipo \"FechaHora\" y su formato correcto es\"aaaa-mm-dd hh:mm:ss\". \"aaaa\" es el a\u00f1o con cuatro d\u00edgitos, \"mm\" es el mes (por ejemplo, enero = 1), \"dd\" es el d\u00eda del mes, \"hh\" es la hora con formato de 24 horas, \"mm\" son los minutos y \"ss\" los segundos.";
