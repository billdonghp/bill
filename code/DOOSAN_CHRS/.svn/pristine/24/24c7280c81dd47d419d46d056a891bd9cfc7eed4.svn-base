...
<%	
	   ...
	   String applyType ="TolerenceApply";
	   String sql ="where  TOLERENCE_NO in (select apply_no from ess_affirm eo  "+
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <td  height="30"  align="center"><a href="/ess/ess0508_t.jsp?NO=<%=tolerence.getTolerenceNo()%>&applyType=TolerenceApply&adminid=<%=admin.getAdminID()%>&flag=1&menu_code=<%=menu_code%>"><font color="#00CC00">通过</font></a><font color="#00CC00">/</font><a href="/ess/ess0508_t.jsp?TolerenceNo=<%=tolerence.getTolerenceNo()%>&applyType=TolerenceApply&adminid=<%=admin.getAdminID()%>&flag=2&menu_code=<%=menu_code%>"><font color="#00CC00">不通过</font></a></td>
