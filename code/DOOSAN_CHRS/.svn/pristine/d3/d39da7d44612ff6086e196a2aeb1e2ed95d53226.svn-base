...
{	
    ...
    document.form1.action="/gaControlServlet?operation=InsertAssetCmd&menu_code=${param.menu_code}";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				<td align="left" class="title1" colspan="10">添加资产基本信息</td>
			</tr>
		</table>
		<table width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td class="info_content_00"><ait:codeClass name="assetType"
					codeClass="AssetType" selected="${assetType}" all="all" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="info_content_00"><input type="text" name="buyDate"
					size="15" onclick="setday(this)" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="info_content_00"><input type="text"
					name="capitalAssetNo" size="15" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="info_content_00"><input type="text" name="examineDate"
					size="15" onclick="setday(this)" required/></td>
			</tr>
			<tr>
