/*
 * @(#)ViewResignCmd.java 1.0 2006-12-19 下午05:04:55
 *
 ...
 * @Date 2006-12-19 下午05:04:55
 * @version 1.0
 * 
 */
public class ViewResignCmd extends HrmAbstractCommand {
	    ...
	    try {
			...
			sMap.put("ADMINID", adminId);
			  UserConfiguration config = UserConfiguration.getInstance("/system.properties");
			    ...
			    map.put("tablename","HR_RESIGNATION");
		    ...
		    throw new GlRuntimeException(" ViewResignCmd request Exception.",
			    e);
		}
		return "/hrm/hrm_dl_resign.jsp";
	}
