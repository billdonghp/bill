/*
 * @(#)DelTrainingComCmd.java 1.0 2007-1-5 下午02:02:24
 *
 ...
 * @Date 2007-1-5 下午02:02:24
 * @version 1.0
 * 
 */
public class DelTrainingComCmd extends HrmAbstractCommand {
	...
	try {
	    ...
	    services.delStudying(lStudying);
	...
	//跳转的新页
	request.setAttribute("url", "/hrmControlServlet?operation=searchTraining&menu_code="+request.getParameter("menu_code"));
