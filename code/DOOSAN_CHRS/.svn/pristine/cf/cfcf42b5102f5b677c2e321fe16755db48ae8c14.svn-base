...
public class GetFoodInfoForInsertSchemeCmd implements Command{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List presentInfoList = gaServices.selectFoodProduct(parameterObject);
        ...
        if (presentInfoList.size() > 0) {           
            ...
            while(iter.hasNext()) {
            	...
            	str.append("<td>") ; 
            	str.append( simpleMap.getString("PRICE") ) ;
            	str.append("</td>") ;
