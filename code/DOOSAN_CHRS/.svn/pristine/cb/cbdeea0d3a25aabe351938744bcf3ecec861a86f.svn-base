...
function search(){
//重新搜索时应重置当前页数
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=BasicInformation1&menu_code=${param.menu_code}";
	document.ApplyForm.submit();
}

function Add() {
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=addWasteBasicInformationView1&menu_code=${param.menu_code}";
	document.ApplyForm.submit();
}
function Update() {
	...
	document.ApplyForm.action="/gmControlServlet?operation=waste&content=updateWasteBasicInformationView1&menu_code=${param.menu_code}&wasteId="+document.ApplyForm.temp.value;
	document.ApplyForm.submit();
}
function Delete() {
	if(document.ApplyForm.temp.value=="") {
	...
	if(confirm('确定删除吗？')){
		document.ApplyForm.action="/gmControlServlet?operation=waste&content=deleteWaste1&menu_code=${param.menu_code}&wasteId=" + document.ApplyForm.temp.value;
		document.ApplyForm.submit();
	}
}
