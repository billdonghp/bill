...
function Save() {
	...
	document.form1.action="/safeControlServlet?operation=jobHealth&content=PositionDiseaseDiseaseTypeAdd&menu_code=${param.menu_code}";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" >
			<tr>
				<td align="left" class="title1" colspan="10">岗位与职业危害设置</td>
			</tr>
		</table>
