/*
 * @(#)RetrieveDataForInsertRelationCmd.java 1.0 2006-12-19 下午05:03:22
 *
 ...
 * 
 */
public class RetrieveDataForInsertRelationCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		return "/hrm/hrm_add_relation.jsp";
	}
