...
<table width="100%" border="0"   cellpadding="0"	cellspacing="0">
	<tr>
		...
		<td background="../images/tablbk01_r1_c2.gif">
			<!-- display toolbar -->
		<%@ include file="../evs/inc/evs0136toolbar_v.jsp"%> 
		</td>
	      ...
	      <td >
	      	<table width="100%" height="30" border="0" cellpadding="0"
				cellspacing="1" class="dr_d">
	       		 <tr>
	       		 	<td class="info_title_01" width="120">权限类型</td> 
	       		 	<FORM name="LGFORM" method="POST" action="/evs/<%=menu_code%>.jsp" >
					<td height="2" align="right" class="info_content_00">
					<input type="hidden" name="menu_code" value="<%=menu_code%>">
					<select name="code_name"	onchange="LGFORM.submit();">
						<option value='' <%if(code_name.equals("")){out.print(" selected ");}%>>选择</option>
						
						<option value=<%="1"%>	<%if(code_name.equals("1")){out.print(" selected ");}%>>数据导出权限</option>
						<option value=<%="2"%>	<%if(code_name.equals("2")){out.print(" selected ");}%>>邮件抄送人权限</option>
	 ...
	 <tr>
		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<tr align="center" onClick="HighLightTR('#F0F1F4','black','','')">
				...
				<div align="center">权限类型</div>
				</td>
				<td width="15%" class="info_title_01">
				<div align="center">权限人员工号</div>
				</td>
				 <td width="15%" class="info_title_01">
				<div align="center">权限人员姓名</div>
				</td>
	            ...
	            <%
					List levcodeid=evscraft.getEvsRightCodename(code_name);
					if(levcodeid!=null){ 
