...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="99%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" valign="middle" style="padding:3 0 3 0 "><ait:history />
				</td>
				<td align="right" valign="middle" style="padding:3 0 3 0 "><ait:image
					src="/images/btn/Search.gif" align="absmiddle"
					onclick="javascript:Search();" style="cursor:hand" /> <ait:image
					src="/images/btn/Bulk_Affirm.gif" align="absmiddle"
					onclick="javascript:Confirm('',1,true,-1);" style="cursor:hand" />
				<ait:image src="/images/btn/Bulk_Reject.gif" align="absmiddle"
					onclick="javascript:Confirm('',2,true,-1);" style="cursor:hand" />
