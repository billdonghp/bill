...
function Save()
{
	...
	document.form1.action="/gmControlServlet?operation=gm_vegetable_save&menu_code=${param.menu_code}";
	...
	<tr>
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="5"
			...
			<tr>
				...
				<td class="info_content_00"><input name="veget_id"
					id="veget_id" type="text" size="10" maxlength="4"/>
				</td>
			</tr>
			<tr>
				...
				<td class="info_content_00"><input name="veget_name"
					id="veget_name" type="text" size="20"  />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="info_content_00">
					<input type="text" style="width:95px" name="login_date"  onClick="setday(this);" value="<%=today%>" readonly="readonly"/>
				</td>
			</tr>
