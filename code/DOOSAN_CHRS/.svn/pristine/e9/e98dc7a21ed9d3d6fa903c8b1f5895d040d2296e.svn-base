...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF" style="padding: 2px 2px 2px 2px;">
  ...
  <tr align="center">
    ...
    <td  height="30"  align="center"><%=foreignlanguage.getChineseName()%>&nbsp;</td>
    ...
    <td  height="30"  align="center"><font color="#CC0000"><%=foreignlanguage.getModifierID()%>&nbsp;通过</font></td>
    ...
    <td  height="30"  align="center"><font color="#CC0000"><%=foreignlanguage.getModifierID()%>&nbsp;未通过</font></td>
	        <%}%>
	<td  height="30"  align="center"><%if(foreignlanguage.getActivity()==0){%><a href="/ess/ess0600_t.jsp?menu_code=<%=menu_code%>&NO=<%=foreignlanguage.getLanguageNo()%>&operate=foreignlanguage">删除</a><%}%>&nbsp;</td>
