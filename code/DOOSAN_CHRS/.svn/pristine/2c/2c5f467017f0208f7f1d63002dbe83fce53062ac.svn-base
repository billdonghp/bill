...
<%@ page import="com.ait.utils.FormUtil,com.ait.util.NumberUtil"%>
...
<jsp:useBean id="payPlan02Serche" class="java.util.ArrayList" scope="request"></jsp:useBean>
...
function Search(){
 document.form1.action="/paControlServlet?operation=paPlan&content=payPlan02Serche&menu_code=pa0402";
...
alert("请输入版本信息！");
 ...
 document.form1.action="/paControlServlet?operation=paPlan&content=payPlan02Save&menu_code=pa0402";
 document.form1.submit();
}
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<br>
		<table width="100%"  border="1" cellspacing="0" cellpadding="0" bordercolorlight="#E7E7E7" bordercolordark="#FFFFFF">
			...
			<%for(int i=0;i<payPlan02Serche.size();i++){ 
			dataMap =(SimpleMap)payPlan02Serche.get(i);%>
			 <tr>
