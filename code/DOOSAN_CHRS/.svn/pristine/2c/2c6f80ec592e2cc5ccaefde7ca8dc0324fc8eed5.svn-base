...
function updateValue(cell) {
            ...
            location.href="/hrmControlServlet?operation=${toolbarInfo.operation}&empID=" + cell.childNodes[0].firstChild.nodeValue + "&menu_code=${toolbarInfo.menu_code}";
            layerClose();
}
        ...
        <tr>
          ...
          <td width="14%" class="info_content_00" nowrap style="padding-top: 2px;padding-bottom: 2px;">
          	...
          	<input id="empName" name="empName" size="8" value="<ait:content enContent='${basic.pinyinName}' zhContent='${basic.chineseName}' koContent='${basic.koreanName}'/>" 
          		onkeyup="send(this.value,this.id)" title='<ait:message  messageID="alert.emp.staff_info.basic_info.search_name" module="hrm" />'/>
          		(<c:out value='${basic.pinyinName}'/>)
          ...
          <td width="15%" class="info_content_00" style="padding-top: 2px;padding-bottom: 2px;">
            <input id="empID" name="empID" size="8" value="<c:out value='${basic.empID}'/>" 
                onkeyup="send(this.value,this.id)" title='<ait:message  messageID="alert.emp.staff_info.basic_info.search_emp_id" module="hrm" />'/></td>
