...
function Add()
	{
	  document.LGFORM.action="/evsControlServlet?operation=evsstypeadd&menu_code=<%=request.getParameter("menu_code")%>";
	  document.LGFORM.submit();
	}
</script>
...
<table width="100%" border="0"   cellpadding="0"
	...
	<tr>
		...
		<td background="../images/tablbk01_r1_c2.gif">
			<!-- display toolbar -->
 		<%@ include file="../evs/inc/evs0129toolbar_v.jsp"%>  
		</td>
	      ...
	      <td >
	      	<table width="100%" height="30" border="0" cellpadding="0"
				cellspacing="1" class="dr_d">
					...
					<td class="info_title_01" width="80">技能类型</td> 
					...
					<select name="code_name1"
						...
						<option value='' <%if(code_name1.equals("")){out.print(" selected ");}%>>技能类型</option>
						<%
					List lEvstypecodename = evscraft.getEvscodeStypeList();
	 ...
	 <tr>
		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<tr align="center" onClick="HighLightTR('#F0F1F4','black','','')">
				...
				<td width="15%" class="info_title_01">
				<div align="center">技能类型ID</div>
				</td>
				<td width="15%" class="info_title_01">
				<div align="center">技能类型名称</div>
				</td>
				<td width="15%" class="info_title_01">
				<div align="center">技能类型英文名称</div>
				</td>
				 <td width="15%" class="info_title_01">
	            ...
	            <%
	                if(code_name!=null)
	                {
					  List levStypecodeid=evscraft.getEvsStypeCodename(code_name,code_name1);
