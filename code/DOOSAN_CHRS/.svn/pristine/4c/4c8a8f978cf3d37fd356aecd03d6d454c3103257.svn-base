...
<table width="100%" border="0" cellpadding="0" cellspacing="0"　class="dr_d" height="154">
  <tr>
	...
	<table border="0" cellpadding="0" cellspacing="1" class="dr_d">
        <tr>
          <td width="101" height="121" valign="middle" class="info_title_01">
		  <img align="middle" src="upload/photo/<c:out value='${basic.empID}'/>.jpg" <c:if test="${basic.photoPath == ''}"> alt="暂无相片 请上传" </c:if> width="100" height="120" onClick="javscript:window.open('/util/photoChange.jsp?empid=<c:out value="${basic.empID}"/>','photo','width=800,height=170')" style="cursor:hand ">
		  </td>
        </tr>
      </table></td>
    <td><table width="100%" height="121"  border="0" cellpadding="0" cellspacing="1" class="dr_d">
      <tr>
        ...
        <tr>
          ...
          <td class="info_content_00" ><!--<c:out value='${basic.position}'/>-->
