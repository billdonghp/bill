...
public class RetrieveDiffDataUtilCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			throw new GlRuntimeException("retrieve pa diff param data Exception. ", e);
		}

		return "util/kpa_diff_util.jsp" ;
	}
