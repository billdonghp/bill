...
function Add(){
	...
	document.form1.action="hrmControlServlet?menu_code=hr0107&operation=retrieveDataForInsertRelation&empID=<c:out value='${empID}'/>";
	document.form1.submit();
 }
 
function Update(){

	document.form1.action="hrmControlServlet?menu_code=hr0107&operation=retrieveDataForUpdateRelation&empID=<c:out value='${empID}'/>";
	document.form1.submit();
}

function Delete(){
	
	document.form1.action="hrmControlServlet?menu_code=hr0107&operation=retrieveDataForDeleteRelation&empID=<c:out value='${empID}'/>";
	document.form1.submit();
}
