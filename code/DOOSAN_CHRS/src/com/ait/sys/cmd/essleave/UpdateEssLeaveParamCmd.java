...
public class UpdateEssLeaveParamCmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            // validate R_TIEM
			int result = syservice.validateUpdateEssLeaveParam(parameterObject);
			if (result != 0) {
			...
			// update
			syservice.updateEssLeaveParam(parameterObject);

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("update EssLeaveParam Exception. ", e);
		}
//		修改成功
