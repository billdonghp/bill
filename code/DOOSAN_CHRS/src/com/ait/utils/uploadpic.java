...
public class uploadpic {
	...
	public uploadpic(HttpServletRequest request, HttpServletResponse response,
		...
		for (int i = 0; i < 1; i++) {
			if (isup[i]) {
				try {
					...
					fe.printStackTrace();
					System.out.println("inStream is not ok!");
				}
			}
		}
		/*
	...
	public byte[] getFileBytes() {
		...
		try {
			...
			System.out.println("Upload::getFileBytes Error:" + e);
		}
		return photobyte;
	}
}
