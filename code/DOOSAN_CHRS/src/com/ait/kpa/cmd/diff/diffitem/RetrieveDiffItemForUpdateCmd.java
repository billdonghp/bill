...
public class RetrieveDiffItemForUpdateCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Object diffItem = null ;
	    
		try {
			// bind parameter
			parameterObject = ObjectBindUtil.getData(request);
			
			diffItem = services.retrieveDiffItem(parameterObject) ;
			
			request.setAttribute("diffItem", diffItem);
		...
		return "/kpa_diff_item_update.jsp?menu_code=" + request.getParameter("menu_code") ; 
	}
}