...
public class InsertDiffFormularCmd extends PaAbstractCommand {
...
/*			String statTypeCode = "";
			...
			services.insertDiffFormular(parameterObject) ;
		...
		request.setAttribute("url","/kpaControlServlet?operation=kpa_diff_formular_data&menu_code=" + parameterObject.getString("menu_code") + "&pa_item_no=" + parameterObject.getString("pa_item_no") );
