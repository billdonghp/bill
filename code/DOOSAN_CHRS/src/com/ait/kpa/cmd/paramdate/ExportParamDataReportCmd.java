...
public class ExportParamDataReportCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			columns.setString("职号","GROUP_EMP_ID");
			...
			List recordList = paService.retrieveParamDataList(parameterObject);
			
			 // 定义列类型
			 SimpleMap columnType = new SimpleMap();
			 columnType.setInt("GROUP_EMP_ID", ReportConstant.CELL_TYPE_TEXT);
			 
//			 设置报表参数
			ExcelParameterBean paramBean = new ExcelParameterBean();
			paramBean.setFileName("kparam_data.xls");
			paramBean.setSheetname("PARAM_DATA");
