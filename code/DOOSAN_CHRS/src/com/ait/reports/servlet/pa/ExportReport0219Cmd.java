...
public class ExportReport0219Cmd extends ArAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		try {
			...
			paramBean.setFileName("pa_detail_factory_average.xls");
			...
			throw new GlRuntimeException("export pa_detail_factory_average record report Exception. ", e);
		}
	...
	private List setInfo78000000(HttpServletRequest request, HttpServletResponse response, SimpleMap columns) {
		...
		return service.retrieve780Report0219List(parameterObject);
	...
	private List setInfo60000000(HttpServletRequest request, HttpServletResponse response, SimpleMap columns) {
		...
		return service.retrieve600Report0219List(parameterObject);
	...
	private List setInfo63000000(HttpServletRequest request, HttpServletResponse response, SimpleMap columns) {
		...
		return service.retrieve630Report0219List(parameterObject);
