...
public class ExportReport0539Cmd extends ArAbstractCommand {
...
//			 columns.setString("熟练度", "PROFIC");
//			 columns.setString("设备保全", "SHEPQ");
//			 columns.setString("作业基准书", "OPERA");
//			 columns.setString("作业品质", "QUALIT");
//			 columns.setString("标准动作", "STAND");			 
			 columns.setString("平均得分", "COMPOS"); 
	...
	private List setInfo78000000(HttpServletRequest request, HttpServletResponse response, SimpleMap columns) {
		...
		return service.retrieve780Report0539List(parameterObject);
	}
