 ...
 * 
 */
public class InsertAttRecordCmd extends ArAbstractCommand {
...
//				刷卡时间不再有效范围之内.
			...
			services.insertAttRecord(parameterObject);

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("insert attendance record Exception. ", e);
		}
//		添加成功
