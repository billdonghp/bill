...
public class ArControlServlet extends ControlServlet {

	private CommandManager manager;

	private static final Logger logger = Logger
			.getLogger(ArControlServlet.class);
	...
	public void init(ServletConfig config) throws ServletException {
		...
		manager = CommandManager.getInstance(config.getServletContext()
				.getRealPath("/"), "navigation.ar.path");
	...
	protected Command resolveCommand(HttpServletRequest request)
		...
		try {
			...
			throw new GlRuntimeException("Resolve ar command Exception. ", e);
		}
