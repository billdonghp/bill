 ...
 * 
 */
public class HrmEmployeeCmd implements Command {
	...
	public String execute(HttpServletRequest request,
        ...
        if (empList.size() > 0) {           
            ...
            while(iter.hasNext()) {
                ...
                // 姓名
            	str.append("<td height='25' class='info_search_02' nowrap='nowrap'>") ; 
            	str.append(basic.getPosition()!=null?basic.getPosition():"无" ) ;
            	str.append("</td>") ;
            	//ID
            	str.append("<td height='25' class='info_search_02' nowrap='nowrap'>") ; 
            	...
            	str.append("</td>") ;
                 //公司名称
            	str.append("<td height='25' class='info_search_02' nowrap='nowrap'>") ; 
            	str.append(basic.getCpnyName()) ;
            	str.append("</td>") ;
            	
            	str.append("</tr>") ;
            }
        } else {	
        	str.append("<tr><td colspan='6' align='center'>") ;
//        	没有你要查询的人员！
