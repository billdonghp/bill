...
public class EssSearchInsteadAffirmCmd implements Command {
	...
	public String execute(HttpServletRequest request,
		...
		List empList = services.retrieveInsteadAffirmList(parameterObject);	    	
        ...
        if (empList.size() > 0) {           
            ...
            while(iter.hasNext()) {
            	...
            	str.append("<tr  onClick='updateValue(this,"+mark+");'>") ;
            	//工号
