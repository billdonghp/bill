 ...
 * 
 */
public class HrmSearchEmployeeCmd implements Command {
	...
	public String execute(HttpServletRequest request,
		...
		parameterObject.setString("DEPTID", StringUtil.checkNull(request.getParameter("deptid")));
		parameterObject.setString("cpnyId", cpnyId);
		List empList=null;
		String menuCode = request.getParameter("menu_code");
		if(menuCode!=null && menuCode.equals("sy0140")){
			empList = services.retrieveEmpListNotCpnyId(parameterObject);
		}else{
			empList = services.retrieveEmpList(parameterObject);
		}
