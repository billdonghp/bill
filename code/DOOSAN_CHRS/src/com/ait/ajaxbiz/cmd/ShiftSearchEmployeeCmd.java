...
public class ShiftSearchEmployeeCmd implements Command {
	...
	public String execute(HttpServletRequest request,
		...
		str.append("<tr style='position: relative; top: expression(this.offsetParent.scrollTop);'  title='"+message.getMessage("alert.mutual.click_close")+"'>") ;
		//全选 
		str.append("<td  height='25' class='info_title_01' nowrap='nowrap'><a href='#' onclick='checkAll();' style='color:red;'>") ;
		str.append("全选") ;
		str.append("</a></td>") ;
        ...
        if (empList.size() > 0) {           
            ...
            while(iter.hasNext()) {
            	...
            	str.append("' onClick='updateValue(this);'>") ;
            	str.append("<td height='25' class='info_search_02' nowrap='nowrap'>") ; 
            	str.append("<input type='checkbox' name='checkFalg' value='") ;
            	str.append(basic.getEmpID()) ;
            	str.append("'/></td>") ;
            	//职号
            	str.append("<td height='25' class='info_search_02' nowrap='nowrap'>") ; 
