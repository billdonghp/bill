...
public class RegularlyArModifySentMailTask  extends TimerTask{

	private static final Logger logger = Logger.getLogger(SparateDataTask.class);

	private RegularlyArModifySentMailTaskProcessor processor = new RegularlyArModifySentMailTaskProcessor();
