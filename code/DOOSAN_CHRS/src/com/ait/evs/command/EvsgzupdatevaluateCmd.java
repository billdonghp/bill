...
public class EvsgzupdatevaluateCmd  implements Command{

				private static final Logger logger = Logger
				.getLogger(EvsgzupdatevaluateCmd.class);
			...
			Object searchLine = services.getEvscodeIrcraftList0(simpleMap);  
			request.setAttribute("searchLine", searchLine); 
			request.setAttribute("resultCount", resultCount);                    
			request.setAttribute("currentPage", currentPage);
			request.setAttribute("pageSize", pageSize);
			request.setAttribute("pageGroupsize", pageGroupSize);  
			return "/evs0125_m.jsp";
		}
}
