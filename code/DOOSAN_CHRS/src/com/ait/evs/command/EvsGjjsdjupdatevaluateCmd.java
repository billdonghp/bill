...
public class EvsGjjsdjupdatevaluateCmd  implements Command{

				private static final Logger logger = Logger
				.getLogger(EvsGjjsdjupdatevaluateCmd.class);
			...
			Object searchLine = services.getEvsgxjsdjList(simpleMap);  
