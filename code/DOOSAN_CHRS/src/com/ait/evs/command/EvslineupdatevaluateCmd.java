...
public class EvslineupdatevaluateCmd  implements Command{
			...
			Object searchLine = services.getEvscodeList4(simpleMap);  
			List<SimpleMap> searchExpiredLine2 = services.getEvscodeList5(codefalg);  
			List<SimpleMap> searchExpiredLine3 = services.getEvscodeList6(simpleMap);  
