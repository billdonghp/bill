/*
 * @(#)DeleteClothingCmd.java 1.0 2009-7-23 上午09:03:12
 *
 ...
 * @Date 2009-7-23 上午09:03:12
 * @version 1.0
 * 
 */
public class DeleteClothingCmd extends GaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			services.updateClothing(parameterObject);

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("Delete clothing Exception. ", e);
		}
		...
		request.setAttribute("url","gaControlServlet?operation=retrieveClothingList&menu_code=" + parameterObject.getString("menu_code")
								   + "&clothingId=" + parameterObject.getString("clothingId"));
