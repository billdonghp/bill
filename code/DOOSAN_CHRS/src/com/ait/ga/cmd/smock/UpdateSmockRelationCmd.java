...
public class UpdateSmockRelationCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			parameterObject.setString("uppersonId", admin.getPersonId());
			
			// update present
			services.updateSmockRelation(parameterObject);

		} catch (Exception e) {

			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("Update smock relation Exception. ", e);
		}
