...
public class RetrieveSmockListCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List recordList = services.selectSmockLsit(parameterObject, currentPage, pageSize);
			int recordCount = NumberUtil.parseInt(services.selectSmockNumber(parameterObject));
			...
			new GlRuntimeException(
					"retrieve smock list Exception. ",e);
		}
		this.putToolbarInfo(request);
		return "/ga_view_smockInfo.jsp?menu_code="+ parameterObject.getString("menu_code");
	}
