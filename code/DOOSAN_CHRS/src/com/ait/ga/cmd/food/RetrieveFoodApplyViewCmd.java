...
public class RetrieveFoodApplyViewCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List recordList = services.selectFoodApply(parameterObject);
			Object recordCount = services.selectFoodApplyCut(parameterObject);
			...
			request.setAttribute("apply_date", request.getParameter("apply_date"));
			...
			throw new GlRuntimeException(
					"Retrieve food apply view list cmd Exception. ",e);
		}
		
		this.putToolbarInfo(request);
		
		return "/ga_food_apply_view.jsp?menu_code="+ parameterObject.getString("menu_code");
	}
}
