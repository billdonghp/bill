...
public class RetrieveFoodProductCmd extends GaAbstractCommand{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List recordList = services.selectFoodProduct(parameterObject, currentPage, pageSize);
			Object recordCount = services.selectFoodProductCut(parameterObject);
			...
			throw new GlRuntimeException(
					"Retrieve food product list cmd Exception. ",e);
		}
		
		this.putToolbarInfo(request);
		
		return "/ga_food_product_view.jsp?menu_code="+ parameterObject.getString("menu_code");
	}
