 ...
 * 
 */
public class DeletePresentYtglCmd extends GaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			services.updatePresentYtgl(parameterObject);
		...
		request.setAttribute("url","gaControlServlet?operation=ytglPresentList&menu_code=" + parameterObject.getString("menu_code")
