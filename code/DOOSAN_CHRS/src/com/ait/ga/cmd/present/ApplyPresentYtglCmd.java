 ...
 * 
 */
public class ApplyPresentYtglCmd extends GaAbstractCommand {
...
//		}
			...
			request.setAttribute("url", "/gaControlServlet?operation=managerDeptApplyPresent&menu_code=" + parameterObject.getString("menu_code"));
