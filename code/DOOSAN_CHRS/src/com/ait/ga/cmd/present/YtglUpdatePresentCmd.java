 ...
 * 
 */
public class YtglUpdatePresentCmd extends GaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			List list = services.ytglPresentList(parameterObject);
		...
		return "/ga_modify_present_ytgl.jsp?menu_code=" + parameterObject.getString("menu_code");
	}
