...
public class GmVegetableOpinionSaveCommand extends ArAbstractCommand {
...
//			}
			...
			//  insertGmVegetableOpinion
			gm.insertGmVegetableOpinion(parameterObject);
...
//		添加成功
		...
		request.setAttribute("url","/gmControlServlet?operation=gm_vegetable_opinion_add&menu_code=" + parameterObject.getString("menu_code"));
