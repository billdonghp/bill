...
public class InsertPaBonusFormularCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("url","/paControlServlet?operation=pa_bonus_formular_data&menu_code=" + parameterObject.getString("menu_code") + "&pa_item_no=" + parameterObject.getString("pa_item_no") );
