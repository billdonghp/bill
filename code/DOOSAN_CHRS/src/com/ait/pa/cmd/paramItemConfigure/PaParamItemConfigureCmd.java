...
package com.ait.pa.cmd.paramItemConfigure;
...
public class PaParamItemConfigureCmd extends PaAbstractCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			else 
			{
				...
				request.setAttribute("url","/paControlServlet?operation=paParamItemConfigureList&menu_code=" + parameterObject.getString("menu_code") );
				
				if (method.equals("add"))
				{
					int errCount = this.services.validateAddPaParamConfigure(parameterObject) ;
				...
				{
					int errCount = this.services.validateUpdatePaParamConfigure(parameterObject) ;
	...
	public String list(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			List<SimpleMap> paParamItimConfigureList  = this.services.retrievePaParamConfigureList(parameterObject, currentPage, pageSize) ;
			
			resultCount = this.services.retrievePaParamConfigureListCnt(parameterObject) ;
			
			request.setAttribute("paParamItimConfigureList", paParamItimConfigureList) ;
		...
		return "/pa_param_item_configure.jsp?menu_code=" + parameterObject.getString("menu_code") ;
	}
	...
	public String delete(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			this.services.deletePaParamConfigure(parameterObject) ;
			
		}
		catch(Exception e)
		{
			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("delete pa param item Configure Exception. ", e);
		}
		return null ;
	}
	...
	public String updateView(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			List<SimpleMap> paParamItimConfigureList  = this.services.retrievePaParamConfigureList(parameterObject) ;
			
			request.setAttribute("paParamItimConfigure", paParamItimConfigureList.get(0)) ;
		...
		return "/pa_param_item_configure_update.jsp?menu_code=" + parameterObject.getString("menu_code") ;
	}
	...
	public String update(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			this.services.updatePaParamConfigure(parameterObject) ;
		}
		catch(Exception e)
		{
			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("update pa param item Configure Exception. ", e);
		}
		return null ;
	}
	...
	public String addView(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			List<SimpleMap> paParamItimList  = this.services.retrievePaParamList(parameterObject) ;
			
			request.setAttribute("paParamItim", paParamItimList.get(0)) ;
		...
		return "/pa_param_item_configure_add.jsp?menu_code=" + parameterObject.getString("menu_code") ;
	}
	...
	public String insert(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			this.services.insertPaParamConfigure(parameterObject) ;
		}
		catch(Exception e)
		{
			Logger.getLogger(getClass()).error(e.toString());
			throw new GlRuntimeException("insert pa param item Configure Exception. ", e);
		}
		return null ;
	}
}