...
public class PaDsHrDAO {
	...
	public void createDsHrTable(Object parameterObject) throws GlRuntimeException {
		...
		try {
			...
			commonSQLMapAdapter.update("pa.dshr.createDsHrTable",parameterObject) ;
	...
	public int checkDsHrTable(Object parameterObject) throws GlRuntimeException {
		...
		try {
			...
			result = NumberUtil.parseInt(commonSQLMapAdapter.executeQuery("pa.dshr.checkDsHrTable",parameterObject)) ;
	...
	public List retrieveDsHrColumns(Object parameterObject) throws GlRuntimeException {
		...
		try {
			...
			result = commonSQLMapAdapter.executeQueryForMulti("pa.dshr.retrieveDsHrColumns",parameterObject);
	...
	public void alertDsHrColumns(List parameterObject) throws GlRuntimeException {
		...
		try {
			...
			commonSQLMapAdapter.updateForMulti("pa.dshr.alertDsHrColumns",parameterObject);
