...
public class GetUserName {
	...
	public static void main(String[] args) {
		try {
			...
			String a = getUserName.getEncodeUserName("2610737");
			System.out.println(a);
			// b = 83/0' -1
			// a = j^/7*-./5
			System.out.println(getUserName.getDecodeUserNameErp("j^/7*-./5"));
			System.out.println(getUserName.getDecodeUserNameErp("83/0' -1"));
