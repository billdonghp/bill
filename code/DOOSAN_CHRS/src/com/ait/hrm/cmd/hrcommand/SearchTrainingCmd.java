/*
 * @(#)SearchTrainingCmd.java 1.0 2007-1-5 下午02:02:03
 *
 ...
 * @Date 2007-1-5 下午02:02:03
 * @version 1.0
 * 
 */
public class SearchTrainingCmd extends HrmAbstractCommand {
	...
	try {
	    ...
	    List list= services.getStudying(sMap, currentPage,pageSize);
	    resultCount = NumberUtil.parseInt(services.getStudyingCnt(sMap).toString(), 0);
	...
	return "/hrm/hrm_dl_search_training.jsp";
    }
