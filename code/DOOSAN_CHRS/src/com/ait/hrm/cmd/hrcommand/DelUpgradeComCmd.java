/*
 * @(#)DelUpgradeCmd.java 1.0 2007-1-5 下午01:52:58
 *
 ...
 * @Date 2007-1-5 下午01:52:58
 * @version 1.0
 * 
 */
public class DelUpgradeComCmd extends HrmAbstractCommand {
	...
	try {
	    ...
	    services.delExpInside(lExpInside);
	    
	} catch (Exception e) {
	    Logger.getLogger(getClass()).error(e.toString());
	    msg="保存失败";
	    throw new GlRuntimeException("删除调动信息失败！", e);
	}
	//提示
	request.setAttribute("alert", msg);
	//跳转的新页
	request.setAttribute("url", "/hrmControlServlet?operation=searchUpgrade&menu_code="+request.getParameter("menu_code"));
