/*
 * @(#)SearchResignCmd.java 1.0 2007-1-5 下午02:00:15
 *
 ...
 * @Date 2007-1-5 下午02:00:15
 * @version 1.0
 * 
 */
public class SearchResignCmd extends HrmAbstractCommand {
	...
	try {
	    ...
	    List list = services.getResignation(sMap, currentPage,pageSize);
	    resultCount = NumberUtil.parseInt(services.getResignationCnt(sMap).toString(), 0);
	...
	return "/hrm/hrm_dl_search_resign.jsp";
    }
