/*
 * @(#)ViewHortationCmd.java 1.0 2007-4-24 下午02:49:56
 *
 ...
 * @Date 2007-4-24 下午02:49:56
 * @version 1.0
 * 
 */
public class ViewHortationCmd extends HrmAbstractCommand{
	...
	public String execute(HttpServletRequest request,
		...
		try {
		    ...
		    throw new GlRuntimeException(" ViewHortationCmd request Exception.", e);
		}
		return "/hrm/hrm_dl_hortation.jsp";
	    }
