/*
 * @(#)ViewPluralityCmd.java 1.0 2006-12-19 下午05:02:44
 *
 ...
 * @Date 2006-12-19 下午05:02:44
 * @version 1.0
 * 
 */
public class ViewPluralityCmd extends HrmAbstractCommand {
	...
	try {
		...
		//兼职                                
		if (transCode.equals(SyCodeServices.getPluralityCode())) {
		...
		//兼职解除
		    ...
		    list=services.getPlurality(sMap,currentPage,pageSize);
		    resultCount = NumberUtil.parseInt(services.getPluralityCnt(sMap).toString(), 0);
		}	
	  }
	    SimpleMap map=new SimpleMap();      
	    map.put("tablename","HR_PLURALITY");
	    ...
	    throw new GlRuntimeException(" ViewPluralityCmd request Exception.", e);
	}
	return "/hrm/hrm_dl_plurality.jsp";
    }  
//    @SuppressWarnings("unchecked")
//    private void putPluralityEmpList(HttpServletRequest request){
//	SimpleMap sMap = new SimpleMap();
...
//	sMap.put("ACTIVITY", "0");
//	HrmServices services = HrmServices.getInstance();   
//	List list = services.getPlurality(sMap);
//	request.setAttribute("emp_list", list);
