/*
 * @(#)SearchDispatchComCmd.java 1.0 2007-1-5 下午01:57:04
 *
 ...
 * @Date 2007-1-5 下午01:57:04
 * @version 1.0
 * 
 */
public class SearchDispatchCmd extends HrmAbstractCommand {
	...
	try {
	    ...
	    List list = services.getDispatch(sMap, currentPage,pageSize);
	    resultCount = NumberUtil.parseInt(services.getDispatchCnt(sMap).toString(), 0);
	...
	return "/hrm/hrm_dl_search_dispatch.jsp";
    }
