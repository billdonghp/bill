/*
 * @(#)DelDispatchComCmd.java 1.0 2007-1-5 下午01:57:35
 *
 ...
 * @Date 2007-1-5 下午01:57:35
 * @version 1.0
 * 
 */
public class DelDispatchComCmd extends HrmAbstractCommand {
...
//	删除派遣信息
	...
	try {
	    ...
	    services.delDispatch(lDispatch);
	...
	//跳转的新页
	request.setAttribute("url", "/hrmControlServlet?operation=searchDispatch&menu_code="+request.getParameter("menu_code"));
