/*
 * @(#)DeleteEvaluateCmd.java 1.0 2007-9-21 上午09:39:46
 *
...
public class DeleteEvaluateCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		this.filtrateData(evList, request, "append");   
		
		services.deleteEvaluateById(evList, true);                     
