/*
 * @(#)InsertAppendInfoCmd.java 1.0 2006-12-19 下午04:46:17
 *
 ...
 * 
 */
public class InsertAppendInfoCmd extends HrmAbstractCommand {
	...
	public String execute(HttpServletRequest request,
		...
		ObjectBindUtil.setFormBean(request, new Additional(), appendList, 3,
				"_");

		// filtrate data
		this.filtrateData(appendList, request.getParameter("appendSign").split(
				","));

		services.insertAdditionalInfo(appendList, true);
