...
public class Swagger2MarkupTest {
    ...
    public void createSpringfoxSwaggerJson() throws Exception {
        ...
        MvcResult mvcResult = this.mockMvc.perform(get("/v2/api-docs?group=mobile-api")
        ...
        Files.write(Paths.get(outputDir, "swagger.json"), swaggerJson.getBytes("utf-8"));
